"""N1 trade-calendar patch helpers scoped to 20260527."""
...
TRADE_DATE = "20260527"
EXCHANGE = "SSE"
PATCH_BATCH_ID = "trade_calendar_20260527_patch_v1"
PATCH_SOURCE_VERSION = PATCH_BATCH_ID
PATCH_SCOPE_KEY = f"{EXCHANGE}:{TRADE_DATE}"
EXPECTED_PREV_TRADE_DATE = "20260526"
DEFAULT_FALLBACK_NEXT_TRADE_DATE = "20260528"
DEFAULT_DSN = base.DEFAULT_DSN
DEFAULT_PREFLIGHT_JSON_PATH = "docs/N1_trade_calendar_20260527_patch_preflight.json"
DEFAULT_PREFLIGHT_MARKDOWN_PATH = "docs/N1_TRADE_CALENDAR_20260527_PATCH_PREFLIGHT.md"
DEFAULT_ROLLBACK_SQL_PATH = "sql/N1_trade_calendar_20260527_patch_rollback.sql"

ALLOWED_WRITE_TABLES = base.ALLOWED_WRITE_TABLES
FORBIDDEN_WRITE_TABLES = base.FORBIDDEN_WRITE_TABLES


class CalendarPatch20260527Blocked(RuntimeError):
    """Raised when the 20260527 calendar patch safety gate is not open."""
...
def _normalize_report(report: Mapping[str, Any], snapshot: Mapping[str, Any]) -> dict[str, Any]:
    ...
    normalized["stage"] = "N1 trade calendar 20260527 patch preflight"
...
def validate_execute_request(
    *,
    ...
    try:
        ...
        raise CalendarPatch20260527Blocked(str(exc)) from exc
