...
- candidate_row_count: `5776`
- subscription_row_count: `3028`
...
- previous_day_minute_subscription_count: `277`
- previous_day_minute_object_count: `277`
- previous_day_minute_object_count_by_asset_kind: `{'stock': 241, 'index': 2, 'board': 34}`
- previous_day_minute_date_counts: `{'20260602': 277}`
- expected_minute_bar_count_per_object: `240`
- estimated_minute_bar_row_count: `66480`
- estimated_minute_bar_row_count_by_asset_kind: `{'stock': 57840, 'index': 480, 'board': 8160}`
- preload_pull_plan_row_count: `3`

## Source Adapter Plan

- board: adapter=`BoardMarketDataAdapter` subscriptions=`34` objects=`34` previous_day_minute_date=`20260602` expected_minute_bar_rows=`8160`
- index: adapter=`IndexMarketDataAdapter` subscriptions=`2` objects=`2` previous_day_minute_date=`20260602` expected_minute_bar_rows=`480`
- stock: adapter=`StockMarketDataAdapter` subscriptions=`241` objects=`241` previous_day_minute_date=`20260602` expected_minute_bar_rows=`57840`
...
- P0 passed previous_day_minute_subscriptions_present: expected=>0 actual=277
