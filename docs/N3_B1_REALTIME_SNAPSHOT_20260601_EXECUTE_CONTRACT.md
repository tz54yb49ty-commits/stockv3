...
- rollback_sql_path: `sql/N3_B1_realtime_snapshot_20260601_rollback.sql`
...
- P0 passed n3_b1_snapshot_run_id_distinct: expected=distinct non-empty snapshot_run_id actual=realtime_snapshot_20260601_market_data_subscription_20260601_condition_layer_20260529_source_20260529_v6
...
Rollback SQL was generated at `sql/N3_B1_realtime_snapshot_20260601_rollback.sql`. It deletes rows by `source_run_id`, `snapshot_run_id`, and `for_trade_date`; it includes scoped outbox/inbox/checkpoint prechecks and does not modify downstream tables.
