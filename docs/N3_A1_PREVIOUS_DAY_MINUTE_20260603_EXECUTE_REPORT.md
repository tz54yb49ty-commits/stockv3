...
- objects_processed: `277`
- minute_rows_written: `66480`
- preload_status_rows_written: `277`
...
- stock: objects=`241` minute_rows=`57840` passed=`241` partial=`0` missing=`0` failed=`0`
- index: objects=`2` minute_rows=`480` passed=`2` partial=`0` missing=`0` failed=`0`
- board: objects=`34` minute_rows=`8160` passed=`34` partial=`0` missing=`0` failed=`0`

## Post Checks

- n3_a1_asset_object_count_matches_a0: `True`
- n3_a1_expected_status_counts: `{'stock': 241, 'index': 2, 'board': 34}`
- n3_a1_actual_status_counts: `{'stock': 241, 'index': 2, 'board': 34}`
- n3_a1_minute_rows_reasonable: `True`
- n3_a1_total_minute_rows_present: `True`
- n3_a1_expected_minute_rows_by_asset: `{'stock': 57840, 'index': 480, 'board': 8160}`
- n3_a1_actual_minute_rows_by_asset: `{'stock': 57840, 'index': 480, 'board': 8160}`
...
- n3_a1_object_status_counts: `{'passed': 277}`
...
- n3_a1_global_event_counts_before: `{'common_event_outbox': 164214, 'common_event_inbox': 68560, 'common_event_consumer_checkpoint': 5163}`
- n3_a1_global_event_counts_after: `{'common_event_outbox': 164214, 'common_event_inbox': 68560, 'common_event_consumer_checkpoint': 5163}`
