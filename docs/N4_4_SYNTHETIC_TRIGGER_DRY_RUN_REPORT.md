# N4-synthetic-canonical-refresh-after-v2-execute-preflight Synthetic Trigger Dry-Run Report

## Summary

- stage: N4-synthetic-canonical-refresh-after-v2-execute-preflight
...
- by_signal_type: {'BUY_HINT': 213, 'B_BUY': 13122, 'SELL_HINT': 207, 'S_SELL': 13110}
- by_action_mark: {'30m_shrink': 6624, '30m_volume': 6632, 'normal': 13396}
- by_legacy_signal_type: {'BUY_HINT': 213, 'B_BUY': 6561, 'B_BUY_30M_VOL': 6561, 'SELL_HINT': 207, 'S_SELL': 6555, 'S_SELL_30M_SHRINK': 6555}
...
- matched_by_signal_type: {'BUY_HINT': 71, 'B_BUY': 4374, 'SELL_HINT': 69, 'S_SELL': 4370}
- matched_by_action_mark: {'30m_shrink': 2254, '30m_volume': 2258, 'normal': 4372}
- pending_by_signal_type: {'BUY_HINT': 142, 'B_BUY': 8748, 'SELL_HINT': 138, 'S_SELL': 8740}
- pending_by_action_mark: {'30m_shrink': 4370, '30m_volume': 4374, 'normal': 9024}
...
- stale_n4_outbox_count: 54068
- stale_n4_outbox_by_source_run: [{'source_run_id': 'trigger_context_snapshot_20260525_condition_layer_20260522_to_20260525_20260524014029_execute', 'event_type': 'TriggerMatched', 'row_count': 8884}, {'source_run_id': 'trigger_context_snapshot_20260525_condition_layer_20260522_to_20260525_20260524014029_execute', 'event_type': 'TriggerPendingMarketData', 'row_count': 17768}, {'source_run_id': 'trigger_context_snapshot_20260525_condition_layer_20260522_to_20260525_20260525003855_execute', 'event_type': 'TriggerMatched', 'row_count': 8884}, {'source_run_id': 'trigger_context_snapshot_20260525_condition_layer_20260522_to_20260525_20260525003855_execute', 'event_type': 'TriggerPendingMarketData', 'row_count': 17768}, {'source_run_id': 'trigger_projection_matcher_execute_20260525_condition_layer_20260522_to_20260525102249', 'event_type': 'TriggerMatched', 'row_count': 488}, {'source_run_id': 'trigger_projection_matcher_execute_20260525_condition_layer_20260522_to_20260525102249', 'event_type': 'TriggerPendingMarketData', 'row_count': 276}]
...
- P0 passed n4_4_trigger_context_run_ready: expected=trigger_context_snapshot_20260525_condition_layer_20260522_to_20260525_20260525102249_execute actual=trigger_context_snapshot_20260525_condition_layer_20260522_to_20260525_20260525102249_execute
...
- P0 passed n4_4_canonical_payload_alignment: expected=canonical_payload_invalid_count=0 actual=0
- P0 passed n4_4_no_current_context_outbox_available: expected=0 actual=0
- P0 passed n4_4_existing_outbox_is_prior_run_only: expected=current context run outbox is absent actual=old_n4_outbox_count=54068 current_context_run_outbox_count=0
