...
- market_data_run_id: `market_data_subscription_20260605_b2_stock_index_lineage_expansion_condition_layer_20260604_source_20260604_v1`
...
- market_data_run_id: `market_data_subscription_20260605_b2_stock_index_lineage_expansion_condition_layer_20260604_source_20260604_v1`
- source_scope_row_count: `6696`
- candidate_row_count: `6696`
- subscription_row_count: `3350`
- subscription_object_count: `1675`
- required_data_kind_counts: `{'minute_bar_1m': 1675, 'previous_day_minute_bar_1m': 1675}`
- dedup_ratio: `0.500299`

## Preload Plan

- previous_day_minute_subscription_count: `1675`
- previous_day_minute_object_count: `1675`
- previous_day_minute_object_count_by_asset_kind: `{'stock': 1668, 'index': 7, 'board': 0}`
- previous_day_minute_date_counts: `{'20260604': 1675}`
- expected_minute_bar_count_per_object: `240`
- estimated_minute_bar_row_count: `402000`
- estimated_minute_bar_row_count_by_asset_kind: `{'stock': 400320, 'index': 1680, 'board': 0}`
- preload_pull_plan_row_count: `2`

## Source Adapter Plan

- index: adapter=`IndexMarketDataAdapter` subscriptions=`7` objects=`7` previous_day_minute_date=`20260604` expected_minute_bar_rows=`1680`
- stock: adapter=`StockMarketDataAdapter` subscriptions=`1668` objects=`1668` previous_day_minute_date=`20260604` expected_minute_bar_rows=`400320`
...
- P0 passed previous_day_minute_subscriptions_present: expected=>0 actual=1675
