...
- expected_row_count: `66480`
- writes_outbox: `False`
- P0/P1/P2: `0/1/0`

## Expected Asset Counts

- stock: objects=`241` subscriptions=`241` expected_minute_rows=`57840`
- index: objects=`2` subscriptions=`2` expected_minute_rows=`480`
- board: objects=`34` subscriptions=`34` expected_minute_rows=`8160`
...
- board: adapter=`BoardMarketDataAdapter` source_pull_plan_id=`90` objects=`34` expected_rows=`8160`
- index: adapter=`IndexMarketDataAdapter` source_pull_plan_id=`93` objects=`2` expected_rows=`480`
- stock: adapter=`StockMarketDataAdapter` source_pull_plan_id=`96` objects=`241` expected_rows=`57840`
...
- rollback_sql_path: `sql/N3_A1_previous_day_minute_20260603_rollback.sql`
...
- P0 passed n3_a1_source_run_id_matches_n3_6: expected=market_data_subscription_20260603_condition_layer_20260602_source_20260602_v1 actual=market_data_subscription_20260603_condition_layer_20260602_source_20260602_v1
...
- P0 passed n3_a1_preload_run_id_distinct: expected=distinct non-empty preload_run_id actual=previous_day_minute_preload_20260602_for_20260603__market_data_subscription_20260603_condition_layer_20260602_source_20260602_v1
- P0 passed n3_a1_asset_counts_match_n3_6: expected={'stock': 241, 'index': 2, 'board': 34} actual={'stock': 241, 'index': 2, 'board': 34}
...
Rollback SQL was generated at `sql/N3_A1_previous_day_minute_20260603_rollback.sql`. It deletes rows by `source_run_id` and `preload_run_id` and does not touch `common_event_outbox`.
