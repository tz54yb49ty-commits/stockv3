...
- expected_row_count: `113520`
- writes_outbox: `False`
- P0/P1/P2: `0/1/0`

## Expected Asset Counts

- stock: objects=`366` subscriptions=`366` expected_minute_rows=`87840`
- index: objects=`21` subscriptions=`21` expected_minute_rows=`5040`
- board: objects=`86` subscriptions=`86` expected_minute_rows=`20640`
...
- board: adapter=`BoardMarketDataAdapter` source_pull_plan_id=`72` objects=`86` expected_rows=`20640`
- index: adapter=`IndexMarketDataAdapter` source_pull_plan_id=`75` objects=`21` expected_rows=`5040`
- stock: adapter=`StockMarketDataAdapter` source_pull_plan_id=`78` objects=`366` expected_rows=`87840`
...
- rollback_sql_path: `sql/N3_A1_previous_day_minute_20260601_rollback.sql`
...
- P0 passed n3_a1_source_run_id_matches_n3_6: expected=market_data_subscription_20260601_condition_layer_20260529_source_20260529_v6 actual=market_data_subscription_20260601_condition_layer_20260529_source_20260529_v6
- P0 passed n3_a1_n3_6_source_p0_zero: expected=P0=0 passed=true actual=P0=0 passed=True
- P0 passed n3_a1_previous_day_minute_date_matches_prev_trade_date: expected=20260529 actual=20260529
- P0 passed n3_a1_preload_run_id_distinct: expected=distinct non-empty preload_run_id actual=previous_day_minute_preload_20260529_for_20260601__market_data_subscription_20260601_condition_layer_20260529_source_20260529_v6
- P0 passed n3_a1_asset_counts_match_n3_6: expected={'stock': 366, 'index': 21, 'board': 86} actual={'stock': 366, 'index': 21, 'board': 86}
...
Rollback SQL was generated at `sql/N3_A1_previous_day_minute_20260601_rollback.sql`. It deletes rows by `source_run_id` and `preload_run_id` and does not touch `common_event_outbox`.
