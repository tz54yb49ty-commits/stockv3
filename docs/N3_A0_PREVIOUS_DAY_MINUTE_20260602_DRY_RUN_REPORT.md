...
- prev_trade_date / data_trade_date: `20260601`
- expected_previous_day_minute_date: `20260601`
- blocked: `False`
- execute_ready: `True`
...
- market_data_run_id: `market_data_subscription_20260602_condition_layer_20260601_source_20260601_v1`
- source_scope_row_count: `5941`
- candidate_row_count: `7879`
- subscription_row_count: `4425`
- subscription_object_count: `2487`
- required_data_kind_counts: `{'minute_bar_1m': 969, 'previous_day_minute_bar_1m': 969, 'realtime_daily_snapshot': 2487}`
- dedup_ratio: `0.561619`

## Preload Plan

- previous_day_minute_subscription_count: `969`
- previous_day_minute_object_count: `969`
- previous_day_minute_object_count_by_asset_kind: `{'stock': 765, 'index': 54, 'board': 150}`
- previous_day_minute_date_counts: `{'20260601': 969}`
- expected_minute_bar_count_per_object: `240`
- estimated_minute_bar_row_count: `232560`
- estimated_minute_bar_row_count_by_asset_kind: `{'stock': 183600, 'index': 12960, 'board': 36000}`
- preload_pull_plan_row_count: `3`

## Source Adapter Plan

- board: adapter=`BoardMarketDataAdapter` subscriptions=`150` objects=`150` previous_day_minute_date=`20260601` expected_minute_bar_rows=`36000`
- index: adapter=`IndexMarketDataAdapter` subscriptions=`54` objects=`54` previous_day_minute_date=`20260601` expected_minute_bar_rows=`12960`
- stock: adapter=`StockMarketDataAdapter` subscriptions=`765` objects=`765` previous_day_minute_date=`20260601` expected_minute_bar_rows=`183600`
...
- P0 passed previous_day_minute_subscriptions_present: expected=>0 actual=969
- P0 passed previous_day_subscription_trade_date_matches_expected: expected=20260601 actual=matched
- P0 passed expected_previous_day_minute_date_matches_prev_trade_date: expected=20260601 actual=20260601
- P0 passed previous_day_pull_plan_trade_date_matches_expected: expected=20260601 actual=matched
