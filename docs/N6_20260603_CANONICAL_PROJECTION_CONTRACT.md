# N6 20260603 Canonical Projection Contract
...
This contract prepares N6 shadow user projection for the 20260603 canonical N5
action run. This gate is readiness / dry-run / preflight only:
...
```text
display_basis_missing=1252
current_price_missing=1252
target_price_missing=1252
expected_return_pct_missing=1252
board_context_missing=1252
```
