# N4 Worker Bounded Smoke 500 Scope Readiness
...
Existing smoke rows are already registered evidence and are not blockers for the new 500-scope run because the target `smoke_run_id` and `consumer_name` are distinct.
...
event_id/dedup_key/partition_key/event_schema_version/payload_json present=500/500
distinct event_id/dedup_key=500/500
```
...
run_id=500/500
snapshot_id=500/500
pull_plan_id=500/500
subscription_id=500/500
source_adapter=500/500
data_quality_status=500/500
payload event_schema_version=500/500
```
...
```text
smoke_run_id=n4_worker_bounded_smoke_20260608_500_scope_probe
consumer_name=n4_trigger_worker_v1_bounded_smoke_500_scope_probe
```
...
```text
path=sql/N4_worker_bounded_smoke_20260608_500_scope_probe_rollback.sql
scoped smoke_run_id=n4_worker_bounded_smoke_20260608_500_scope_probe
scoped consumer=n4_trigger_worker_v1_bounded_smoke_500_scope_probe
...
```text
N4_WORKER_BOUNDED_SMOKE_500_SCOPE_CONTRACT_GATE
```
