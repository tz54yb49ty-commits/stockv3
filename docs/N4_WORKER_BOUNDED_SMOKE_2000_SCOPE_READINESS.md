# N4 Worker Bounded Smoke 2000 Scope Readiness
...
1000 scope smoke=POST_REVIEW_PASS
...
Existing smoke rows are already registered evidence and are not blockers for the new 2000-scope run because the target `smoke_run_id` and `consumer_name` are distinct.
...
event_id/dedup_key/partition_key/event_schema_version/payload_json present=2000/2000
...
```text
run_id=2000/2000
snapshot_id=2000/2000
pull_plan_id=2000/2000
subscription_id=2000/2000
source_adapter=2000/2000
data_quality_status=2000/2000
payload event_schema_version=2000/2000
```
...
1000_scope_consumption run/quality/state/match/outbox/inbox/checkpoint=1/2/0/0/0/1000/1000
...
```text
path=sql/N4_worker_bounded_smoke_20260608_2000_scope_probe_rollback.sql
scoped smoke_run_id=n4_worker_bounded_smoke_20260608_2000_scope_probe
scoped consumer=n4_trigger_worker_v1_bounded_smoke_2000_scope_probe
...
```text
N4_WORKER_BOUNDED_SMOKE_2000_SCOPE_CONTRACT_GATE
```
