...
- started_at: 2026-06-02T01:44:02.948319+00:00
- finished_at: 2026-06-02T01:44:08.760993+00:00
- P0/P1/P2: 0/0/0

## Dry-Run Input

- source_scope_row_count: 5941
- source_scope_row_count_by_asset_kind: {'stock': 4715, 'index': 220, 'board': 1006}
- subscription_candidate_count: 7879
- dedup_subscription_count: 4425
- subscription_object_count: 2487
- object_count_by_asset_kind: {'stock': 1976, 'index': 83, 'board': 428}
- required_data_kind_counts: {'minute_bar_1m': 969, 'previous_day_minute_bar_1m': 969, 'realtime_daily_snapshot': 2487}
- previous_day_minute_required_count: 969
...
- common_market_data_subscription_candidate: 7879
- common_market_data_subscription: 4425
...
The rollback SQL is scoped to `market_data_subscription_20260602_condition_layer_20260601_source_20260601_v1`. It hard-fails before any DELETE if there are scoped outbox / inbox / checkpoint refs, downstream N3 fact refs, action-confirmation projection refs, or N4/N5/N6/user refs. If guards pass, it deletes only N3 subscription control rows: pull_plan, subscription, subscription_candidate, quality, and run.
