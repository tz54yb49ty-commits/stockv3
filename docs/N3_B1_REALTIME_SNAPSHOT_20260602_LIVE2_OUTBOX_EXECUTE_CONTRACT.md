...
- stock: objects=`1976` subscriptions=`1976` expected_snapshot_rows=`1976`
...
- board: adapter=`BoardMarketDataAdapter` source_pull_plan_id=`82` objects=`428` expected_rows=`428`
- index: adapter=`IndexMarketDataAdapter` source_pull_plan_id=`85` objects=`83` expected_rows=`83`
- stock: adapter=`StockMarketDataAdapter` source_pull_plan_id=`88` objects=`1976` expected_rows=`1976`
...
- rollback_sql_path: `sql/N3_B1_realtime_snapshot_20260602_live2_outbox_rollback.sql`
...
- P0 passed n3_b1_snapshot_run_id_distinct: expected=distinct non-empty snapshot_run_id actual=realtime_snapshot_20260602_live2_outbox_market_data_subscription_20260602_condition_layer_20260601_source_20260601_v1
- P0 passed n3_b1_asset_counts_match_n3_6: expected={'stock': 1976, 'index': 83, 'board': 428} actual={'stock': 1976, 'index': 83, 'board': 428}
...
Rollback SQL was generated at `sql/N3_B1_realtime_snapshot_20260602_live2_outbox_rollback.sql`. It deletes rows by `source_run_id`, `snapshot_run_id`, and `for_trade_date`; it includes scoped outbox/inbox/checkpoint prechecks and does not modify downstream tables.
