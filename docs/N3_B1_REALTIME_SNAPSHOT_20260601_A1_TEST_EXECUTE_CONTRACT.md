...
- snapshot_run_id: `realtime_snapshot_20260601_a1_test_market_data_subscription_20260601_condition_layer_20260529_source_20260529_v6`
- source_condition_run_id: `condition_layer_20260529_source_20260529_v6`
- for_trade_date: `20260601`
- expected_row_count: `2373`
- writes_outbox: `False`
...
- stock: objects=`1862` subscriptions=`1862` expected_snapshot_rows=`1862`
...
- board: adapter=`BoardMarketDataAdapter` source_pull_plan_id=`73` objects=`428` expected_rows=`428`
- index: adapter=`IndexMarketDataAdapter` source_pull_plan_id=`76` objects=`83` expected_rows=`83`
- stock: adapter=`StockMarketDataAdapter` source_pull_plan_id=`79` objects=`1862` expected_rows=`1862`
...
- rollback_sql_path: `sql/N3_B1_realtime_snapshot_20260601_a1_test_rollback.sql`
...
- P1 warning n3_b1_b0_p1_carried: expected=0 actual=1
- P0 passed n3_b1_source_run_id_matches_n3_6: expected=market_data_subscription_20260601_condition_layer_20260529_source_20260529_v6 actual=market_data_subscription_20260601_condition_layer_20260529_source_20260529_v6
- P0 passed n3_b1_n3_6_source_p0_zero: expected=P0=0 passed=true actual=P0=0 passed=True
- P0 passed n3_b1_snapshot_run_id_distinct: expected=distinct non-empty snapshot_run_id actual=realtime_snapshot_20260601_a1_test_market_data_subscription_20260601_condition_layer_20260529_source_20260529_v6
- P0 passed n3_b1_asset_counts_match_n3_6: expected={'stock': 1862, 'index': 83, 'board': 428} actual={'stock': 1862, 'index': 83, 'board': 428}
...
Rollback SQL was generated at `sql/N3_B1_realtime_snapshot_20260601_a1_test_rollback.sql`. It deletes rows by `source_run_id`, `snapshot_run_id`, and `for_trade_date`; it includes scoped outbox/inbox/checkpoint prechecks and does not modify downstream tables.
