...
- preload_run_id: `previous_day_minute_preload_20260616_for_20260617__market_data_subscription_20260617_condition_layer_20260616_source_20260616_for_20260617_semantic_repair_v1`
...
- board: adapter=`BoardMarketDataAdapter` source_pull_plan_id=`248` objects=`17` expected_rows=`4080`
- index: adapter=`IndexMarketDataAdapter` source_pull_plan_id=`251` objects=`7` expected_rows=`1680`
- stock: adapter=`StockMarketDataAdapter` source_pull_plan_id=`254` objects=`200` expected_rows=`48000`
...
- rollback_sql_path: `sql/V3_20260617_N3_rebuild_after_n2_repair_a1_preload_rollback.sql`
...
- P0 passed n3_a1_source_run_id_matches_n3_6: expected=market_data_subscription_20260617_condition_layer_20260616_source_20260616_for_20260617_semantic_repair_v1 actual=market_data_subscription_20260617_condition_layer_20260616_source_20260616_for_20260617_semantic_repair_v1
- P0 passed n3_a1_n3_6_source_p0_zero: expected=P0=0 passed=true actual=P0=0 passed=True
- P0 passed n3_a1_previous_day_minute_date_matches_prev_trade_date: expected=20260616 actual=20260616
- P0 passed n3_a1_preload_run_id_distinct: expected=distinct non-empty preload_run_id actual=previous_day_minute_preload_20260616_for_20260617__market_data_subscription_20260617_condition_layer_20260616_source_20260616_for_20260617_semantic_repair_v1
- P0 passed n3_a1_asset_counts_match_n3_6: expected={'stock': 200, 'index': 7, 'board': 17} actual={'stock': 200, 'index': 7, 'board': 17}
...
Rollback SQL was generated at `sql/V3_20260617_N3_rebuild_after_n2_repair_a1_preload_rollback.sql`. It deletes rows by `source_run_id` and `preload_run_id` and does not touch `common_event_outbox`.
