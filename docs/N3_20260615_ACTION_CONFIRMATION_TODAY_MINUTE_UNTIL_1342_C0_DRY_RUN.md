...
- result: `DRY_RUN_PASS`
- source_market_data_run_id: `market_data_subscription_20260615_action_confirmation_until_1342_scope__n4_production_semantic_replay_20260615_market_snapshot_updated_until_1342_v1`
...
- expected_bar_count_per_object: `162`
- expected_minute_rows: `139482`
- object_count_by_asset: `{'stock': 860, 'index': 0, 'board': 1}`
- P0/P1/P2: `0/0/0`
...
\set today_minute_run_id 'today_minute_bar_1m_20260615_until_1342_action_confirmation_scope__n4_production_semantic_replay_20260615_market_snapshot_updated_until_1342_v1'
...
DELETE FROM common_market_data_quality_item WHERE run_id = 'today_minute_bar_1m_20260615_until_1342_action_confirmation_scope__n4_production_semantic_replay_20260615_market_snapshot_updated_until_1342_v1';
DELETE FROM stock_minute_bar_1m WHERE run_id = 'today_minute_bar_1m_20260615_until_1342_action_confirmation_scope__n4_production_semantic_replay_20260615_market_snapshot_updated_until_1342_v1' AND is_previous_day_preload = false;
DELETE FROM index_minute_bar_1m WHERE run_id = 'today_minute_bar_1m_20260615_until_1342_action_confirmation_scope__n4_production_semantic_replay_20260615_market_snapshot_updated_until_1342_v1' AND is_previous_day_preload = false;
DELETE FROM board_minute_bar_1m WHERE run_id = 'today_minute_bar_1m_20260615_until_1342_action_confirmation_scope__n4_production_semantic_replay_20260615_market_snapshot_updated_until_1342_v1' AND is_previous_day_preload = false;
DELETE FROM common_market_data_run WHERE run_id = 'today_minute_bar_1m_20260615_until_1342_action_confirmation_scope__n4_production_semantic_replay_20260615_market_snapshot_updated_until_1342_v1' AND downstream_layers_touched = false AND worker_started = false;
