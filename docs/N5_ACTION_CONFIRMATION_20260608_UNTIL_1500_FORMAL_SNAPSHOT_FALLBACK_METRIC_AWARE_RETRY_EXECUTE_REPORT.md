...
- source_run_guard: {'configured': True, 'allowed_source_run_ids': ['trigger_projection_matcher_execute_20260608_v13_index_all_until_1500_formal_snapshot_fallback_retry'], 'denied_source_run_ids': ['trigger_projection_matcher_execute_20260608_v13_index_all_until_1500_v4_repair_retry', 'trigger_projection_matcher_execute_20260608_v13_index_all_until_0952_v4_repair_retry'], 'trigger_run_id': 'trigger_projection_matcher_execute_20260608_v13_index_all_until_1500_formal_snapshot_fallback_retry', 'trigger_run_denied': False, 'trigger_run_not_allowed': False, 'observed_source_run_ids': {'trigger_projection_matcher_execute_20260608_v13_index_all_until_1500_formal_snapshot_fallback_retry': 556}, 'denied_observed_source_run_ids': [], 'outside_allowlist_source_run_ids': [], 'passed': True}
- pending_only_guard: {'allowed_statuses': ['pending'], 'by_status': {'pending': 556}, 'total_row_count': 556, 'pending_count': 556, 'non_pending_count': 0, 'non_pending_sample': [], 'passed': True}
- blockers: []
...
- output_event_plan: {'ActionEligible': 0, 'ActionBlocked': 555, 'ActionExecuted': 1, 'ActionSkipped': 0}
