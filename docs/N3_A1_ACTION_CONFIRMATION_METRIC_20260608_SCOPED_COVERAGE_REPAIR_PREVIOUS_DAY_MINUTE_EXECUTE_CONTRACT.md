...
- expected_row_count: `91440`
- writes_outbox: `False`
- P0/P1/P2: `0/0/0`

## Expected Asset Counts

- stock: objects=`256` subscriptions=`256` expected_minute_rows=`61440`
- index: objects=`48` subscriptions=`48` expected_minute_rows=`11520`
- board: objects=`77` subscriptions=`77` expected_minute_rows=`18480`
...
- board: adapter=`BoardMarketDataAdapter` source_pull_plan_id=`156` objects=`77` expected_rows=`18480`
- index: adapter=`IndexMarketDataAdapter` source_pull_plan_id=`158` objects=`48` expected_rows=`11520`
- stock: adapter=`StockMarketDataAdapter` source_pull_plan_id=`160` objects=`256` expected_rows=`61440`
...
- rollback_sql_path: `sql/N3_A1_action_confirmation_metric_20260608_scoped_coverage_repair_previous_day_minute_rollback.sql`
...
- P0 passed n3_a1_source_run_id_matches_n3_6: expected=market_data_subscription_20260608_action_metric_coverage_repair_v1__trigger_projection_matcher_execute_20260608_v13_index_all_until_1500_formal_snapshot_fallback_retry actual=market_data_subscription_20260608_action_metric_coverage_repair_v1__trigger_projection_matcher_execute_20260608_v13_index_all_until_1500_formal_snapshot_fallback_retry
- P0 passed n3_a1_n3_6_source_p0_zero: expected=P0=0 passed=true actual=P0=0 passed=True
- P0 passed n3_a1_previous_day_minute_date_matches_prev_trade_date: expected=20260605 actual=20260605
- P0 passed n3_a1_preload_run_id_distinct: expected=distinct non-empty preload_run_id actual=previous_day_minute_preload_20260605_for_20260608_action_metric_coverage_repair_v1__market_data_subscription_20260608_action_metric_coverage_repair_v1
- P0 passed n3_a1_asset_counts_match_n3_6: expected={'stock': 256, 'index': 48, 'board': 77} actual={'stock': 256, 'index': 48, 'board': 77}
...
Rollback SQL was generated at `sql/N3_A1_action_confirmation_metric_20260608_scoped_coverage_repair_previous_day_minute_rollback.sql`. It deletes rows by `source_run_id` and `preload_run_id` and does not touch `common_event_outbox`.
