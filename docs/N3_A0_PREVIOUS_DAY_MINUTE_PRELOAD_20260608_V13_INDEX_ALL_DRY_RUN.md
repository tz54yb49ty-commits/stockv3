...
- prev_trade_date / data_trade_date: `20260605`
- expected_previous_day_minute_date: `20260605`
- blocked: `False`
- execute_ready: `True`
...
- market_data_run_id: `market_data_subscription_20260608_condition_layer_20260605_to_20260608_v13_index_all_execute`
- source_scope_row_count: `4677`
- candidate_row_count: `5421`
- subscription_row_count: `2899`
- subscription_object_count: `2155`
- required_data_kind_counts: `{'minute_bar_1m': 372, 'previous_day_minute_bar_1m': 372, 'realtime_daily_snapshot': 2155}`
- dedup_ratio: `0.534772`

## Preload Plan

- previous_day_minute_subscription_count: `372`
- previous_day_minute_object_count: `372`
- previous_day_minute_object_count_by_asset_kind: `{'stock': 353, 'index': 6, 'board': 13}`
- previous_day_minute_date_counts: `{'20260605': 372}`
- expected_minute_bar_count_per_object: `240`
- estimated_minute_bar_row_count: `89280`
- estimated_minute_bar_row_count_by_asset_kind: `{'stock': 84720, 'index': 1440, 'board': 3120}`
- preload_pull_plan_row_count: `3`

## Source Adapter Plan

- board: adapter=`BoardMarketDataAdapter` subscriptions=`13` objects=`13` previous_day_minute_date=`20260605` expected_minute_bar_rows=`3120`
- index: adapter=`IndexMarketDataAdapter` subscriptions=`6` objects=`6` previous_day_minute_date=`20260605` expected_minute_bar_rows=`1440`
- stock: adapter=`StockMarketDataAdapter` subscriptions=`353` objects=`353` previous_day_minute_date=`20260605` expected_minute_bar_rows=`84720`
...
- P0 passed previous_day_minute_subscriptions_present: expected=>0 actual=372
- P0 passed previous_day_subscription_trade_date_matches_expected: expected=20260605 actual=matched
- P0 passed expected_previous_day_minute_date_matches_prev_trade_date: expected=20260605 actual=20260605
- P0 passed previous_day_pull_plan_trade_date_matches_expected: expected=20260605 actual=matched
