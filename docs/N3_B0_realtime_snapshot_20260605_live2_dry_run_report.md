...
- snapshot_subscription_count: `2389`
- snapshot_object_count: `2389`
- expected_snapshot_rows: `2389`
- writes_outbox: `false`
...
- board: adapter=`BoardMarketDataAdapter` objects=`428` expected_snapshot_rows=`428` target=`board_realtime_daily_snapshot`
- index: adapter=`IndexMarketDataAdapter` objects=`9` expected_snapshot_rows=`9` target=`index_realtime_daily_snapshot`
- stock: adapter=`StockMarketDataAdapter` objects=`1952` expected_snapshot_rows=`1952` target=`stock_realtime_daily_snapshot`
...
- P0 passed realtime_snapshot_subscriptions_present: expected=>0 actual=2389
