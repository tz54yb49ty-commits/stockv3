...
- preload_run_id: `previous_day_minute_preload_20260615_until_1342_action_confirmation_scope__n4_production_semantic_replay_20260615_market_snapshot_updated_until_1342_v1`
...
- expected_row_count: `206640`
- writes_outbox: `False`
- P0/P1/P2: `0/0/0`

## Expected Asset Counts

- stock: objects=`860` subscriptions=`860` expected_minute_rows=`206400`
- index: objects=`0` subscriptions=`0` expected_minute_rows=`0`
- board: objects=`1` subscriptions=`1` expected_minute_rows=`240`
...
- board: adapter=`BoardMarketDataAdapter` source_pull_plan_id=`194` objects=`1` expected_rows=`240`
- stock: adapter=`StockRealtimeQuoteAdapter` source_pull_plan_id=`196` objects=`860` expected_rows=`206400`
...
- rollback_sql_path: `sql/N3_20260615_action_confirmation_previous_day_preload_until_1342_rollback.sql`
...
- P0 passed n3_a1_source_run_id_matches_n3_6: expected=market_data_subscription_20260615_action_confirmation_until_1342_scope__n4_production_semantic_replay_20260615_market_snapshot_updated_until_1342_v1 actual=market_data_subscription_20260615_action_confirmation_until_1342_scope__n4_production_semantic_replay_20260615_market_snapshot_updated_until_1342_v1
...
- P0 passed n3_a1_preload_run_id_distinct: expected=distinct non-empty preload_run_id actual=previous_day_minute_preload_20260615_until_1342_action_confirmation_scope__n4_production_semantic_replay_20260615_market_snapshot_updated_until_1342_v1
- P0 passed n3_a1_asset_counts_match_n3_6: expected={'stock': 860, 'index': 0, 'board': 1} actual={'stock': 860, 'index': 0, 'board': 1}
- P0 passed n3_a1_source_adapter_plan_covers_assets: expected=stock,board actual=stock,board
...
Rollback SQL was generated at `sql/N3_20260615_action_confirmation_previous_day_preload_until_1342_rollback.sql`. It deletes rows by `source_run_id` and `preload_run_id` and does not touch `common_event_outbox`.
