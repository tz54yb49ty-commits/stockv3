...
- snapshot_subscription_count: `2181`
- snapshot_object_count: `2181`
- expected_snapshot_rows: `2181`
- writes_outbox: `false`
...
- index: adapter=`IndexMarketDataAdapter` objects=`9` expected_snapshot_rows=`9` target=`index_realtime_daily_snapshot`
- stock: adapter=`StockMarketDataAdapter` objects=`2045` expected_snapshot_rows=`2045` target=`stock_realtime_daily_snapshot`
...
- status: `passed`
- missing_object_count: `10`
- missing_samples: `stock:BJ:920045, stock:BJ:920068, stock:BJ:920116, stock:BJ:920125, stock:BJ:920178, stock:BJ:920185, stock:BJ:920186, stock:BJ:920438, stock:BJ:920808, stock:BJ:920982`
...
- P0 passed realtime_snapshot_subscriptions_present: expected=>0 actual=2181
...
- P1 warning n3_b0_preload_missing_carried_non_blocking: expected=0 actual=10
