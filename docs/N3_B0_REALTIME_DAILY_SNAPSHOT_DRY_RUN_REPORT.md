...
- snapshot_subscription_count: `2188`
- snapshot_object_count: `2188`
- expected_snapshot_rows: `2188`
...
- stock: adapter=`StockMarketDataAdapter` objects=`2052` expected_snapshot_rows=`2052` target=`stock_realtime_daily_snapshot`
...
- missing_samples: `stock:BJ:920045, stock:BJ:920068, stock:BJ:920116, stock:BJ:920178, stock:BJ:920185, stock:BJ:920186, stock:BJ:920438, stock:BJ:920808, stock:BJ:920982`

## Quality

- P0 passed n3_b0_subscription_run_clean: expected=N3-6 subscription run passed and P0=0 actual=passed=True p0=0
- P1 warning n3_b0_subscription_run_p1_carried: expected=0 actual=1
- P0 passed realtime_snapshot_subscriptions_present: expected=>0 actual=2188
...
- P1 warning n3_b0_preload_missing_carried_non_blocking: expected=0 actual=9
