...
- prev_trade_date / data_trade_date: `20260612`
- expected_previous_day_minute_date: `20260612`
- blocked: `False`
- execute_ready: `True`
...
- candidate_row_count: `5767`
- subscription_row_count: `3146`
...
- previous_day_minute_subscription_count: `521`
- previous_day_minute_object_count: `521`
- previous_day_minute_object_count_by_asset_kind: `{'stock': 439, 'index': 39, 'board': 43}`
- previous_day_minute_date_counts: `{'20260612': 521}`
- expected_minute_bar_count_per_object: `240`
- estimated_minute_bar_row_count: `125040`
- estimated_minute_bar_row_count_by_asset_kind: `{'stock': 105360, 'index': 9360, 'board': 10320}`
- preload_pull_plan_row_count: `3`

## Source Adapter Plan

- board: adapter=`BoardMarketDataAdapter` subscriptions=`43` objects=`43` previous_day_minute_date=`20260612` expected_minute_bar_rows=`10320`
- index: adapter=`IndexMarketDataAdapter` subscriptions=`39` objects=`39` previous_day_minute_date=`20260612` expected_minute_bar_rows=`9360`
- stock: adapter=`StockMarketDataAdapter` subscriptions=`439` objects=`439` previous_day_minute_date=`20260612` expected_minute_bar_rows=`105360`
...
- P0 passed previous_day_minute_subscriptions_present: expected=>0 actual=521
- P0 passed previous_day_subscription_trade_date_matches_expected: expected=20260612 actual=matched
- P0 passed expected_previous_day_minute_date_matches_prev_trade_date: expected=20260612 actual=20260612
- P0 passed previous_day_pull_plan_trade_date_matches_expected: expected=20260612 actual=matched
