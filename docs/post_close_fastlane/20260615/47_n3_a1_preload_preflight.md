...
```bash
PYTHONPATH=src:scripts python3 scripts/run_previous_day_minute_preload_execute.py --contract-path docs/post_close_fastlane/20260615/46_n3_a1_preload_contract.json --historical-preload --source-subscription-run-id market_data_subscription_20260615_condition_layer_20260612_source_20260612_for_20260615_v1 --preload-run-id previous_day_minute_preload_20260612_for_20260615__market_data_subscription_20260615_condition_layer_20260612_source_20260612_for_20260615_v1 --data-trade-date 20260612 --execute --user-confirmed
```
