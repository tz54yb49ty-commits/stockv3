...
- expected_row_count: `125040`
- writes_outbox: `False`
- P0/P1/P2: `0/0/0`

## Expected Asset Counts

- stock: objects=`439` subscriptions=`439` expected_minute_rows=`105360`
- index: objects=`39` subscriptions=`39` expected_minute_rows=`9360`
- board: objects=`43` subscriptions=`43` expected_minute_rows=`10320`
...
- board: adapter=`BoardMarketDataAdapter` source_pull_plan_id=`180` objects=`43` expected_rows=`10320`
- index: adapter=`IndexMarketDataAdapter` source_pull_plan_id=`183` objects=`39` expected_rows=`9360`
- stock: adapter=`StockMarketDataAdapter` source_pull_plan_id=`186` objects=`439` expected_rows=`105360`
...
- rollback_sql_path: `sql/N3_A1_previous_day_minute_preload_20260612_for_20260615_rollback.sql`
...
- P0 passed n3_a1_source_run_id_matches_n3_6: expected=market_data_subscription_20260615_condition_layer_20260612_source_20260612_for_20260615_v1 actual=market_data_subscription_20260615_condition_layer_20260612_source_20260612_for_20260615_v1
...
- P0 passed n3_a1_preload_run_id_distinct: expected=distinct non-empty preload_run_id actual=previous_day_minute_preload_20260612_for_20260615__market_data_subscription_20260615_condition_layer_20260612_source_20260612_for_20260615_v1
- P0 passed n3_a1_asset_counts_match_n3_6: expected={'stock': 439, 'index': 39, 'board': 43} actual={'stock': 439, 'index': 39, 'board': 43}
...
Rollback SQL was generated at `sql/N3_A1_previous_day_minute_preload_20260612_for_20260615_rollback.sql`. It deletes rows by `source_run_id` and `preload_run_id` and does not touch `common_event_outbox`.
