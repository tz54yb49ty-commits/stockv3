...
- board: adapter=`BoardMarketDataAdapter` source_pull_plan_id=`218` objects=`17` expected_rows=`4080`
- index: adapter=`IndexMarketDataAdapter` source_pull_plan_id=`221` objects=`7` expected_rows=`1680`
- stock: adapter=`StockMarketDataAdapter` source_pull_plan_id=`224` objects=`200` expected_rows=`48000`
...
- P0 passed n3_a1_source_run_id_matches_n3_6: expected=market_data_subscription_20260617_condition_layer_20260616_source_20260616_for_20260617_v1 actual=market_data_subscription_20260617_condition_layer_20260616_source_20260616_for_20260617_v1
...
- P0 passed n3_a1_preload_run_id_distinct: expected=distinct non-empty preload_run_id actual=previous_day_minute_preload_20260616_for_20260617__market_data_subscription_20260617_condition_layer_20260616_source_20260616_for_20260617_v1
...
Rollback SQL was generated at `sql/N3_A1_previous_day_minute_preload_20260616_for_20260617_rollback.sql`. It deletes rows by `source_run_id` and `preload_run_id` and does not touch `common_event_outbox`.
