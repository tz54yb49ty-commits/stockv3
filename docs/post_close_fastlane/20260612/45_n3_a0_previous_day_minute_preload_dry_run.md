...
- market_data_run_id: `market_data_subscription_20260612_condition_layer_20260611_source_20260611_for_20260612_v1`
...
- prev_trade_date / data_trade_date: `20260611`
- expected_previous_day_minute_date: `20260611`
- blocked: `False`
- execute_ready: `True`
...
- market_data_run_id: `market_data_subscription_20260612_condition_layer_20260611_source_20260611_for_20260612_v1`
- source_scope_row_count: `4454`
- candidate_row_count: `5048`
- subscription_row_count: `2676`
- subscription_object_count: `2082`
- required_data_kind_counts: `{'minute_bar_1m': 297, 'previous_day_minute_bar_1m': 297, 'realtime_daily_snapshot': 2082}`
- dedup_ratio: `0.530111`

## Preload Plan

- previous_day_minute_subscription_count: `297`
- previous_day_minute_object_count: `297`
- previous_day_minute_object_count_by_asset_kind: `{'stock': 245, 'index': 33, 'board': 19}`
- previous_day_minute_date_counts: `{'20260611': 297}`
- expected_minute_bar_count_per_object: `240`
- estimated_minute_bar_row_count: `71280`
- estimated_minute_bar_row_count_by_asset_kind: `{'stock': 58800, 'index': 7920, 'board': 4560}`
- preload_pull_plan_row_count: `3`

## Source Adapter Plan

- board: adapter=`BoardMarketDataAdapter` subscriptions=`19` objects=`19` previous_day_minute_date=`20260611` expected_minute_bar_rows=`4560`
- index: adapter=`IndexMarketDataAdapter` subscriptions=`33` objects=`33` previous_day_minute_date=`20260611` expected_minute_bar_rows=`7920`
- stock: adapter=`StockMarketDataAdapter` subscriptions=`245` objects=`245` previous_day_minute_date=`20260611` expected_minute_bar_rows=`58800`
...
- P0 passed previous_day_minute_subscriptions_present: expected=>0 actual=297
- P0 passed previous_day_subscription_trade_date_matches_expected: expected=20260611 actual=matched
- P0 passed expected_previous_day_minute_date_matches_prev_trade_date: expected=20260611 actual=20260611
- P0 passed previous_day_pull_plan_trade_date_matches_expected: expected=20260611 actual=matched
