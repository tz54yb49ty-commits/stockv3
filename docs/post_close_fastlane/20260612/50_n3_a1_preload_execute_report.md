...
- stock: objects=`245` minute_rows=`58800` passed=`245` partial=`0` missing=`0` failed=`0`
- index: objects=`33` minute_rows=`7920` passed=`33` partial=`0` missing=`0` failed=`0`
- board: objects=`19` minute_rows=`4560` passed=`19` partial=`0` missing=`0` failed=`0`

## Post Checks

- n3_a1_asset_object_count_matches_a0: `True`
- n3_a1_expected_status_counts: `{'stock': 245, 'index': 33, 'board': 19}`
- n3_a1_actual_status_counts: `{'stock': 245, 'index': 33, 'board': 19}`
- n3_a1_minute_rows_reasonable: `True`
- n3_a1_total_minute_rows_present: `True`
- n3_a1_expected_minute_rows_by_asset: `{'stock': 58800, 'index': 7920, 'board': 4560}`
- n3_a1_actual_minute_rows_by_asset: `{'stock': 58800, 'index': 7920, 'board': 4560}`
...
- n3_a1_object_status_counts: `{'passed': 297}`
...
- n3_a1_global_event_counts_before: `{'common_event_outbox': 202091, 'common_event_inbox': 117910, 'common_event_consumer_checkpoint': 26439}`
- n3_a1_global_event_counts_after: `{'common_event_outbox': 202091, 'common_event_inbox': 117910, 'common_event_consumer_checkpoint': 26439}`
