...
- previous_day_minute_date: `20260611`
- expected_row_count: `71280`
- writes_outbox: `False`
- P0/P1/P2: `0/0/0`

## Expected Asset Counts

- stock: objects=`245` subscriptions=`245` expected_minute_rows=`58800`
- index: objects=`33` subscriptions=`33` expected_minute_rows=`7920`
- board: objects=`19` subscriptions=`19` expected_minute_rows=`4560`
...
- board: adapter=`BoardMarketDataAdapter` source_pull_plan_id=`171` objects=`19` expected_rows=`4560`
- index: adapter=`IndexMarketDataAdapter` source_pull_plan_id=`174` objects=`33` expected_rows=`7920`
- stock: adapter=`StockMarketDataAdapter` source_pull_plan_id=`177` objects=`245` expected_rows=`58800`
...
- rollback_sql_path: `sql/N3_A1_previous_day_minute_preload_20260611_for_20260612_rollback.sql`
...
- P0 passed n3_a1_source_run_id_matches_n3_6: expected=market_data_subscription_20260612_condition_layer_20260611_source_20260611_for_20260612_v1 actual=market_data_subscription_20260612_condition_layer_20260611_source_20260611_for_20260612_v1
- P0 passed n3_a1_n3_6_source_p0_zero: expected=P0=0 passed=true actual=P0=0 passed=True
- P0 passed n3_a1_previous_day_minute_date_matches_prev_trade_date: expected=20260611 actual=20260611
- P0 passed n3_a1_preload_run_id_distinct: expected=distinct non-empty preload_run_id actual=previous_day_minute_preload_20260611_for_20260612__market_data_subscription_20260612_condition_layer_20260611_source_20260611_for_20260612_v1
- P0 passed n3_a1_asset_counts_match_n3_6: expected={'stock': 245, 'index': 33, 'board': 19} actual={'stock': 245, 'index': 33, 'board': 19}
...
Rollback SQL was generated at `sql/N3_A1_previous_day_minute_preload_20260611_for_20260612_rollback.sql`. It deletes rows by `source_run_id` and `preload_run_id` and does not touch `common_event_outbox`.
