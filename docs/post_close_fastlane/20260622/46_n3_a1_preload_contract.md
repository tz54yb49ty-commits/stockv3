...
- expected_row_count: `32880`
- writes_outbox: `False`
- P0/P1/P2: `0/0/0`

## Expected Asset Counts

- stock: objects=`120` subscriptions=`120` expected_minute_rows=`28800`
...
- board: adapter=`BoardMarketDataAdapter` source_pull_plan_id=`290` objects=`17` expected_rows=`4080`
- stock: adapter=`StockMarketDataAdapter` source_pull_plan_id=`294` objects=`120` expected_rows=`28800`
...
- rollback_sql_path: `sql/N3_A1_previous_day_minute_preload_20260618_for_20260622_rollback.sql`
...
- P0 passed n3_a1_source_run_id_matches_n3_6: expected=market_data_subscription_20260622_condition_layer_20260618_source_20260618_for_20260622_v1 actual=market_data_subscription_20260622_condition_layer_20260618_source_20260618_for_20260622_v1
- P0 passed n3_a1_n3_6_source_p0_zero: expected=P0=0 passed=true actual=P0=0 passed=True
- P0 passed n3_a1_previous_day_minute_date_matches_prev_trade_date: expected=20260618 actual=20260618
- P0 passed n3_a1_preload_run_id_distinct: expected=distinct non-empty preload_run_id actual=previous_day_minute_preload_20260618_for_20260622__market_data_subscription_20260622_condition_layer_20260618_source_20260618_for_20260622_v1
- P0 passed n3_a1_asset_counts_match_n3_6: expected={'stock': 120, 'index': 0, 'board': 17} actual={'stock': 120, 'index': 0, 'board': 17}
...
Rollback SQL was generated at `sql/N3_A1_previous_day_minute_preload_20260618_for_20260622_rollback.sql`. It deletes rows by `source_run_id` and `preload_run_id` and does not touch `common_event_outbox`.
