...
- prev_trade_date / data_trade_date: `20260618`
- expected_previous_day_minute_date: `20260618`
- blocked: `False`
- execute_ready: `True`
...
- candidate_row_count: `2516`
- subscription_row_count: `2243`
...
- previous_day_minute_subscription_count: `137`
- previous_day_minute_object_count: `137`
- previous_day_minute_object_count_by_asset_kind: `{'stock': 120, 'index': 0, 'board': 17}`
- previous_day_minute_date_counts: `{'20260618': 137}`
- expected_minute_bar_count_per_object: `240`
- estimated_minute_bar_row_count: `32880`
- estimated_minute_bar_row_count_by_asset_kind: `{'stock': 28800, 'index': 0, 'board': 4080}`
- preload_pull_plan_row_count: `2`

## Source Adapter Plan

- board: adapter=`BoardMarketDataAdapter` subscriptions=`17` objects=`17` previous_day_minute_date=`20260618` expected_minute_bar_rows=`4080`
- stock: adapter=`StockMarketDataAdapter` subscriptions=`120` objects=`120` previous_day_minute_date=`20260618` expected_minute_bar_rows=`28800`
...
- P0 passed previous_day_minute_subscriptions_present: expected=>0 actual=137
- P0 passed previous_day_subscription_trade_date_matches_expected: expected=20260618 actual=matched
- P0 passed expected_previous_day_minute_date_matches_prev_trade_date: expected=20260618 actual=20260618
- P0 passed previous_day_pull_plan_trade_date_matches_expected: expected=20260618 actual=matched
