...
- expected_row_count: `42480`
- writes_outbox: `False`
- P0/P1/P2: `0/0/0`

## Expected Asset Counts

- stock: objects=`163` subscriptions=`163` expected_minute_rows=`39120`
- index: objects=`3` subscriptions=`3` expected_minute_rows=`720`
...
- board: adapter=`BoardMarketDataAdapter` source_pull_plan_id=`263` objects=`11` expected_rows=`2640`
- index: adapter=`IndexMarketDataAdapter` source_pull_plan_id=`266` objects=`3` expected_rows=`720`
- stock: adapter=`StockMarketDataAdapter` source_pull_plan_id=`269` objects=`163` expected_rows=`39120`
...
- rollback_sql_path: `sql/N3_A1_previous_day_minute_preload_20260617_for_20260618_rollback.sql`
...
- P0 passed n3_a1_source_run_id_matches_n3_6: expected=market_data_subscription_20260618_condition_layer_20260617_source_20260617_for_20260618_v1 actual=market_data_subscription_20260618_condition_layer_20260617_source_20260617_for_20260618_v1
- P0 passed n3_a1_n3_6_source_p0_zero: expected=P0=0 passed=true actual=P0=0 passed=True
- P0 passed n3_a1_previous_day_minute_date_matches_prev_trade_date: expected=20260617 actual=20260617
- P0 passed n3_a1_preload_run_id_distinct: expected=distinct non-empty preload_run_id actual=previous_day_minute_preload_20260617_for_20260618__market_data_subscription_20260618_condition_layer_20260617_source_20260617_for_20260618_v1
- P0 passed n3_a1_asset_counts_match_n3_6: expected={'stock': 163, 'index': 3, 'board': 11} actual={'stock': 163, 'index': 3, 'board': 11}
...
Rollback SQL was generated at `sql/N3_A1_previous_day_minute_preload_20260617_for_20260618_rollback.sql`. It deletes rows by `source_run_id` and `preload_run_id` and does not touch `common_event_outbox`.
