...
- expected_row_count: `152160`
- writes_outbox: `False`
- P0/P1/P2: `0/0/0`

## Expected Asset Counts

- stock: objects=`564` subscriptions=`564` expected_minute_rows=`135360`
- index: objects=`17` subscriptions=`17` expected_minute_rows=`4080`
- board: objects=`53` subscriptions=`53` expected_minute_rows=`12720`
...
- board: adapter=`BoardMarketDataAdapter` source_pull_plan_id=`200` objects=`53` expected_rows=`12720`
- index: adapter=`IndexMarketDataAdapter` source_pull_plan_id=`203` objects=`17` expected_rows=`4080`
- stock: adapter=`StockMarketDataAdapter` source_pull_plan_id=`206` objects=`564` expected_rows=`135360`
...
- rollback_sql_path: `sql/N3_A1_previous_day_minute_preload_20260615_for_20260616_rollback.sql`
...
- P0 passed n3_a1_source_run_id_matches_n3_6: expected=market_data_subscription_20260616_condition_layer_20260615_source_20260615_for_20260616_v1 actual=market_data_subscription_20260616_condition_layer_20260615_source_20260615_for_20260616_v1
- P0 passed n3_a1_n3_6_source_p0_zero: expected=P0=0 passed=true actual=P0=0 passed=True
- P0 passed n3_a1_previous_day_minute_date_matches_prev_trade_date: expected=20260615 actual=20260615
- P0 passed n3_a1_preload_run_id_distinct: expected=distinct non-empty preload_run_id actual=previous_day_minute_preload_20260615_for_20260616__market_data_subscription_20260616_condition_layer_20260615_source_20260615_for_20260616_v1
- P0 passed n3_a1_asset_counts_match_n3_6: expected={'stock': 564, 'index': 17, 'board': 53} actual={'stock': 564, 'index': 17, 'board': 53}
...
Rollback SQL was generated at `sql/N3_A1_previous_day_minute_preload_20260615_for_20260616_rollback.sql`. It deletes rows by `source_run_id` and `preload_run_id` and does not touch `common_event_outbox`.
