...
- preload_run_id: `previous_day_minute_preload_20260527_from_20260526_market_data_subscription_20260527_condition_layer_20260526_source_20260526_v1`
- source_condition_run_id: `condition_layer_20260526_source_20260526_v1`
- for_trade_date: `20260527`
- previous_day_minute_date: `20260526`
- expected_row_count: `523440`
- writes_outbox: `False`
- P0/P1/P2: `0/0/0`

## Expected Asset Counts

- stock: objects=`2045` subscriptions=`2045` expected_minute_rows=`490800`
...
- board: adapter=`BoardMarketDataAdapter` source_pull_plan_id=`38` objects=`127` expected_rows=`30480`
- index: adapter=`IndexMarketDataAdapter` source_pull_plan_id=`41` objects=`9` expected_rows=`2160`
- stock: adapter=`StockMarketDataAdapter` source_pull_plan_id=`44` objects=`2045` expected_rows=`490800`
...
- rollback_sql_path: `sql/N3_A1_previous_day_minute_20260527_rollback.sql`
...
- P0 passed n3_a1_source_run_id_matches_n3_6: expected=market_data_subscription_20260527_condition_layer_20260526_source_20260526_v1 actual=market_data_subscription_20260527_condition_layer_20260526_source_20260526_v1
- P0 passed n3_a1_n3_6_source_p0_zero: expected=P0=0 passed=true actual=P0=0 passed=True
- P0 passed n3_a1_previous_day_minute_date_matches_prev_trade_date: expected=20260526 actual=20260526
- P0 passed n3_a1_preload_run_id_distinct: expected=distinct non-empty preload_run_id actual=previous_day_minute_preload_20260527_from_20260526_market_data_subscription_20260527_condition_layer_20260526_source_20260526_v1
- P0 passed n3_a1_asset_counts_match_n3_6: expected={'stock': 2045, 'index': 9, 'board': 127} actual={'stock': 2045, 'index': 9, 'board': 127}
...
Rollback SQL was generated at `sql/N3_A1_previous_day_minute_20260527_rollback.sql`. It deletes rows by `source_run_id` and `preload_run_id` and does not touch `common_event_outbox`.
