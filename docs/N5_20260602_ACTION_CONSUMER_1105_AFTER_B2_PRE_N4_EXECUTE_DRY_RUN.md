# N5-20260602-after-b2-pre-n4-execute-dry-run Action Consumer Run-Once Dry-Run Report

## Summary

- stage: N5-20260602-after-b2-pre-n4-execute-dry-run
...
- action_run_id: action_consumer_run_once_20260602_1105__trigger_projection_matcher_execute_20260602_1105__condition_layer_20260601_source_20260601_v1
- for_trade_date: None
- rollback_sql_path: sql/N5_20260602_action_consumer_1105_rollback.sql
- P0/P1/P2: 6/0/0
- passed: False
...
- baseline_report_path: docs/N4_20260602_projection_matcher_1105_after_b2_execute_preflight.json
...
- outbox_row_count: 0
- source_run_id: {}
- only_expected_source_run_id: False
...
- BUY_HINT trace matched/pending/total: 0/0/0
- SELL_HINT trace matched/pending/total: 0/0/0
...
- planned_action_fact_by_signal_type: {}
- planned_action_fact_by_direction: {}
- action_state: {}
- confirmation_status: {}
- BUY_HINT planned action fact count: 0
- SELL_HINT planned action fact count: 0
- BUY_HINT trace count: 0
- SELL_HINT trace count: 0
...
- by_event_type: {'ActionEligible': 0, 'ActionBlocked': 0, 'ActionExecuted': 0, 'ActionSkipped': 0}
