...
- stock: objects=`1963` subscriptions=`1963` expected_snapshot_rows=`1963`
...
- board: adapter=`BoardMarketDataAdapter` source_pull_plan_id=`91` objects=`428` expected_rows=`428`
- index: adapter=`IndexMarketDataAdapter` source_pull_plan_id=`94` objects=`83` expected_rows=`83`
- stock: adapter=`StockMarketDataAdapter` source_pull_plan_id=`97` objects=`1963` expected_rows=`1963`
...
- rollback_sql_path: `sql/N3_B1_realtime_snapshot_20260603_rollback.sql`
...
- P0 passed n3_b1_source_run_id_matches_n3_6: expected=market_data_subscription_20260603_condition_layer_20260602_source_20260602_v1 actual=market_data_subscription_20260603_condition_layer_20260602_source_20260602_v1
- P0 passed n3_b1_n3_6_source_p0_zero: expected=P0=0 passed=true actual=P0=0 passed=True
- P0 passed n3_b1_snapshot_run_id_distinct: expected=distinct non-empty snapshot_run_id actual=realtime_snapshot_20260603_market_data_subscription_20260603_condition_layer_20260602_source_20260602_v1
- P0 passed n3_b1_asset_counts_match_n3_6: expected={'stock': 1963, 'index': 83, 'board': 428} actual={'stock': 1963, 'index': 83, 'board': 428}
...
Rollback SQL was generated at `sql/N3_B1_realtime_snapshot_20260603_rollback.sql`. It deletes rows by `source_run_id`, `snapshot_run_id`, and `for_trade_date`; it includes scoped outbox/inbox/checkpoint prechecks and does not modify downstream tables.
