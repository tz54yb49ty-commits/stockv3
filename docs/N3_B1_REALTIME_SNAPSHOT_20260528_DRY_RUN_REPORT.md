...
- snapshot_subscription_count: `2146`
- snapshot_object_count: `2146`
- expected_snapshot_rows: `2146`
- writes_outbox: `false`
...
- stock: adapter=`StockMarketDataAdapter` objects=`2010` expected_snapshot_rows=`2010` target=`stock_realtime_daily_snapshot`
...
- P0 passed realtime_snapshot_subscriptions_present: expected=>0 actual=2146
