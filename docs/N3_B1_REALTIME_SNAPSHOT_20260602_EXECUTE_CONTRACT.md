...
- rollback_sql_path: `sql/N3_B1_realtime_snapshot_20260602_rollback.sql`
...
Rollback SQL was generated at `sql/N3_B1_realtime_snapshot_20260602_rollback.sql`. It deletes rows by `source_run_id`, `snapshot_run_id`, and `for_trade_date`; it includes scoped outbox/inbox/checkpoint prechecks and does not modify downstream tables.
