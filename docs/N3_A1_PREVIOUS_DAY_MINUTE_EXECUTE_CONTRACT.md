...
- source_run_id: `market_data_subscription_20260525_condition_layer_20260522_to_20260525_20260524014029_execute`
- preload_run_id: `previous_day_minute_preload_20260522_for_20260525__market_data_subscription_20260525_condition_layer_20260522_to_20260525_20260524014029_execute`
...
- stock: objects=`2052` subscriptions=`2052` expected_minute_rows=`492480`
...
- board: adapter=`BoardMarketDataAdapter` source_pull_plan_id=`2` objects=`127` expected_rows=`30480`
- index: adapter=`IndexMarketDataAdapter` source_pull_plan_id=`5` objects=`9` expected_rows=`2160`
- stock: adapter=`StockMarketDataAdapter` source_pull_plan_id=`8` objects=`2052` expected_rows=`492480`
...
- P0 passed n3_a1_source_run_id_matches_n3_6: expected=market_data_subscription_20260525_condition_layer_20260522_to_20260525_20260524014029_execute actual=market_data_subscription_20260525_condition_layer_20260522_to_20260525_20260524014029_execute
- P0 passed n3_a1_n3_6_source_p0_zero: expected=P0=0 passed=true actual=P0=0 passed=True
- P0 passed n3_a1_previous_day_minute_date_matches_prev_trade_date: expected=20260522 actual=20260522
- P0 passed n3_a1_preload_run_id_distinct: expected=distinct non-empty preload_run_id actual=previous_day_minute_preload_20260522_for_20260525__market_data_subscription_20260525_condition_layer_20260522_to_20260525_20260524014029_execute
- P0 passed n3_a1_asset_counts_match_n3_6: expected={'stock': 2052, 'index': 9, 'board': 127} actual={'stock': 2052, 'index': 9, 'board': 127}
- P0 passed n3_a1_source_adapter_plan_covers_assets: expected=stock,index,board actual=board,index,stock
...
Rollback SQL was generated at `sql/N3_A1_previous_day_minute_rollback.sql`. It deletes rows by `source_run_id` and `preload_run_id` and does not touch `common_event_outbox`.
