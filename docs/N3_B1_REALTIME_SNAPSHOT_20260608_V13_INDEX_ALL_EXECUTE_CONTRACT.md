...
- stock: objects=`1945` subscriptions=`1945` expected_snapshot_rows=`1945`
...
- board: adapter=`BoardMarketDataAdapter` source_pull_plan_id=`139` objects=`127` expected_rows=`127`
- index: adapter=`IndexMarketDataAdapter` source_pull_plan_id=`142` objects=`83` expected_rows=`83`
- stock: adapter=`StockMarketDataAdapter` source_pull_plan_id=`145` objects=`1945` expected_rows=`1945`
...
- rollback_sql_path: `sql/N3_B1_realtime_snapshot_20260608_v13_index_all_rollback.sql`
...
- P0 passed n3_b1_source_run_id_matches_n3_6: expected=market_data_subscription_20260608_condition_layer_20260605_to_20260608_v13_index_all_execute actual=market_data_subscription_20260608_condition_layer_20260605_to_20260608_v13_index_all_execute
- P0 passed n3_b1_n3_6_source_p0_zero: expected=P0=0 passed=true actual=P0=0 passed=True
- P0 passed n3_b1_snapshot_run_id_distinct: expected=distinct non-empty snapshot_run_id actual=realtime_daily_snapshot_20260608__market_data_subscription_20260608_condition_layer_20260605_to_20260608_v13_index_all_execute
- P0 passed n3_b1_asset_counts_match_n3_6: expected={'stock': 1945, 'index': 83, 'board': 127} actual={'stock': 1945, 'index': 83, 'board': 127}
...
Rollback SQL was generated at `sql/N3_B1_realtime_snapshot_20260608_v13_index_all_rollback.sql`. It deletes rows by `source_run_id`, `snapshot_run_id`, and `for_trade_date`; it includes scoped outbox/inbox/checkpoint prechecks and does not modify downstream tables.
