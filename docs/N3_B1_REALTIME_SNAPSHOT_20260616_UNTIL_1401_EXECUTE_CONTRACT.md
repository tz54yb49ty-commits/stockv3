...
- stock: objects=`1822` subscriptions=`1822` expected_snapshot_rows=`1822`
- index: objects=`83` subscriptions=`83` expected_snapshot_rows=`83`
...
- board: adapter=`BoardMarketDataAdapter` source_pull_plan_id=`201` objects=`127` expected_rows=`127`
- index: adapter=`IndexMarketDataAdapter` source_pull_plan_id=`204` objects=`83` expected_rows=`83`
- stock: adapter=`StockMarketDataAdapter` source_pull_plan_id=`207` objects=`1822` expected_rows=`1822`
...
- rollback_sql_path: `sql/N3_B1_realtime_snapshot_20260616_until_1401_rollback.sql`
...
- P0 passed n3_b1_source_run_id_matches_n3_6: expected=market_data_subscription_20260616_condition_layer_20260615_source_20260615_for_20260616_v1 actual=market_data_subscription_20260616_condition_layer_20260615_source_20260615_for_20260616_v1
- P0 passed n3_b1_n3_6_source_p0_zero: expected=P0=0 passed=true actual=P0=0 passed=True
- P0 passed n3_b1_snapshot_run_id_distinct: expected=distinct non-empty snapshot_run_id actual=realtime_daily_snapshot_20260616_until_1401__market_data_subscription_20260616_condition_layer_20260615_source_20260615_for_20260616_v1
- P0 passed n3_b1_asset_counts_match_n3_6: expected={'stock': 1822, 'index': 83, 'board': 127} actual={'stock': 1822, 'index': 83, 'board': 127}
...
Rollback SQL was generated at `sql/N3_B1_realtime_snapshot_20260616_until_1401_rollback.sql`. It deletes rows by `source_run_id`, `snapshot_run_id`, and `for_trade_date`; it includes scoped outbox/inbox/checkpoint prechecks and does not modify downstream tables.

## 20260616 Fact-Only Source-Time Policy Refresh
...
- raw_snapshot_time_label preserved in trace: `true`
- source_time_trust_level preserved in trace: `true`
