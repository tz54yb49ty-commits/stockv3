...
- market_data_run_id: `market_data_subscription_20260715_condition_layer_20260714_source_20260714_for_20260715_v1`
...
- prev_trade_date / data_trade_date: `20260714`
- expected_previous_day_minute_date: `20260714`
- blocked: `False`
- execute_ready: `True`
...
- market_data_run_id: `market_data_subscription_20260715_condition_layer_20260714_source_20260714_for_20260715_v1`
- source_scope_row_count: `3846`
- candidate_row_count: `11538`
- subscription_row_count: `5502`
- subscription_object_count: `1834`
- required_data_kind_counts: `{'minute_bar_1m': 1834, 'previous_day_minute_bar_1m': 1834, 'realtime_daily_snapshot': 1834}`
- dedup_ratio: `0.476859`

## Preload Plan

- previous_day_minute_subscription_count: `1834`
- previous_day_minute_object_count: `1834`
- previous_day_minute_object_count_by_asset_kind: `{'stock': 1698, 'index': 9, 'board': 127}`
- previous_day_minute_date_counts: `{'20260714': 1834}`
- expected_minute_bar_count_per_object: `240`
- estimated_minute_bar_row_count: `440160`
- estimated_minute_bar_row_count_by_asset_kind: `{'stock': 407520, 'index': 2160, 'board': 30480}`
- preload_pull_plan_row_count: `3`

## Source Adapter Plan

- board: adapter=`BoardMarketDataAdapter` subscriptions=`127` objects=`127` previous_day_minute_date=`20260714` expected_minute_bar_rows=`30480`
- index: adapter=`IndexMarketDataAdapter` subscriptions=`9` objects=`9` previous_day_minute_date=`20260714` expected_minute_bar_rows=`2160`
- stock: adapter=`StockMarketDataAdapter` subscriptions=`1698` objects=`1698` previous_day_minute_date=`20260714` expected_minute_bar_rows=`407520`
...
- P0 passed previous_day_minute_subscriptions_present: expected=>0 actual=1834
- P0 passed previous_day_subscription_trade_date_matches_expected: expected=20260714 actual=matched
- P0 passed expected_previous_day_minute_date_matches_prev_trade_date: expected=20260714 actual=20260714
- P0 passed previous_day_pull_plan_trade_date_matches_expected: expected=20260714 actual=matched
