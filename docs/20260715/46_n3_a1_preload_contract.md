...
- board: adapter=`BoardMarketDataAdapter` source_pull_plan_id=`484` objects=`127` expected_rows=`30480`
- index: adapter=`IndexMarketDataAdapter` source_pull_plan_id=`487` objects=`9` expected_rows=`2160`
- stock: adapter=`StockMarketDataAdapter` source_pull_plan_id=`490` objects=`1698` expected_rows=`407520`
...
- P0 passed n3_a1_source_run_id_matches_n3_6: expected=market_data_subscription_20260715_condition_layer_20260714_source_20260714_for_20260715_v1 actual=market_data_subscription_20260715_condition_layer_20260714_source_20260714_for_20260715_v1
- P0 passed n3_a1_n3_6_source_p0_zero: expected=P0=0 passed=true actual=P0=0 passed=True
- P0 passed n3_a1_previous_day_minute_date_matches_prev_trade_date: expected=20260714 actual=20260714
- P0 passed n3_a1_preload_run_id_distinct: expected=distinct non-empty preload_run_id actual=previous_day_minute_preload_20260714_for_20260715__market_data_subscription_20260715_condition_layer_20260714_source_20260714_for_20260715_v1
- P0 passed n3_a1_asset_counts_match_n3_6: expected={'stock': 1698, 'index': 9, 'board': 127} actual={'stock': 1698, 'index': 9, 'board': 127}
...
Rollback SQL was generated at `sql/N3_A1_previous_day_minute_preload_20260714_for_20260715_rollback.sql`. It deletes rows by `source_run_id` and `preload_run_id` and does not touch `common_event_outbox`.
