...
- action_run_id: n4_n5_n6_chained_shadow_smoke_20260608_action_probe
- consumer_name: n5_action_worker_v1_n4_n5_n6_chained_shadow_probe
- execute: True
- user_confirmed: True
- P0/P1/P2: 0/0/0
- allow_execute: True
...
- source_run_guard: {'configured': True, 'allowed_source_run_ids': ['trigger_projection_matcher_execute_20260608_until_1500_unified_output_retry'], 'denied_source_run_ids': ['trigger_context_snapshot_20260525_condition_layer_20260522_to_20260525_20260524014029_execute', 'trigger_context_snapshot_20260525_condition_layer_20260522_to_20260525_20260525003855_execute'], 'trigger_run_id': 'trigger_projection_matcher_execute_20260608_until_1500_unified_output_retry', 'trigger_run_denied': False, 'trigger_run_not_allowed': False, 'observed_source_run_ids': {'trigger_projection_matcher_execute_20260608_until_1500_unified_output_retry': 50}, 'denied_observed_source_run_ids': [], 'outside_allowlist_source_run_ids': [], 'passed': True}
- pending_only_guard: {'allowed_statuses': ['pending'], 'by_status': {'pending': 50}, 'total_row_count': 50, 'pending_count': 50, 'non_pending_count': 0, 'non_pending_sample': [], 'passed': True}
- blockers: []
...
- output_event_plan: {'ActionEligible': 0, 'ActionBlocked': 50, 'ActionExecuted': 0, 'ActionSkipped': 0}
