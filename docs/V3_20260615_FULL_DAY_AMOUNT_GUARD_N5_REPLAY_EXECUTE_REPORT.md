...
- source_run_guard: {'configured': True, 'allowed_source_run_ids': ['n4_production_semantic_replay_20260615_market_snapshot_updated_until_1500_amount_guard_fix_v1'], 'denied_source_run_ids': ['n4_production_semantic_replay_20260615_market_snapshot_updated_until_1500', 'n4_production_semantic_replay_20260615_market_snapshot_updated_until_1500_amount_guard_fix_v0'], 'trigger_run_id': 'n4_production_semantic_replay_20260615_market_snapshot_updated_until_1500_amount_guard_fix_v1', 'trigger_run_denied': False, 'trigger_run_not_allowed': False, 'observed_source_run_ids': {'n4_production_semantic_replay_20260615_market_snapshot_updated_until_1500_amount_guard_fix_v1': 25}, 'denied_observed_source_run_ids': [], 'outside_allowlist_source_run_ids': [], 'passed': True}
- pending_only_guard: {'allowed_statuses': ['pending'], 'by_status': {'pending': 25}, 'total_row_count': 25, 'pending_count': 25, 'non_pending_count': 0, 'non_pending_sample': [], 'passed': True}
- blockers: []
...
- stock_action_fact: 25
- index_action_fact: 0
- board_action_fact: 0
- common_action_event: 25
- common_event_outbox: 25
- common_event_inbox: 25
- common_event_consumer_checkpoint: 25
- common_position_state: 0
- common_position_event: 0

## Event Mapping

- output_event_plan: {'ActionEligible': 0, 'ActionBlocked': 25, 'ActionExecuted': 0, 'ActionSkipped': 0}
