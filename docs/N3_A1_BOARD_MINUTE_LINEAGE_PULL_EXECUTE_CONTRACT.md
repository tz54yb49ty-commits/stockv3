...
- board: adapter=`BoardMarketDataAdapter` source_pull_plan_id=`126` objects=`28` expected_rows=`6720`
...
- P0 passed n3_a1_source_run_id_matches_n3_6: expected=market_data_subscription_20260605_action_metric_board_lineage_repair_condition_layer_20260604_source_20260604_v1 actual=market_data_subscription_20260605_action_metric_board_lineage_repair_condition_layer_20260604_source_20260604_v1
...
- P0 passed n3_a1_preload_run_id_distinct: expected=distinct non-empty preload_run_id actual=previous_day_minute_preload_20260604_for_20260605_action_metric_board_lineage_repair__market_data_subscription_20260605_action_metric_board_lineage_repair_condition_layer_20260604_source_20260604_v1
- P0 passed n3_a1_asset_counts_match_n3_6: expected={'stock': 0, 'index': 0, 'board': 28} actual={'stock': 0, 'index': 0, 'board': 28}
- P0 passed n3_a1_source_adapter_plan_covers_assets: expected=board actual=board
...
Rollback SQL was generated at `sql/N3_A1_board_minute_lineage_pull_20260605_rollback.sql`. It deletes rows by `source_run_id` and `preload_run_id` and does not touch `common_event_outbox`.
