...
- snapshot_subscription_count: `2373`
- snapshot_object_count: `2373`
...
- stock: adapter=`StockMarketDataAdapter` objects=`1862` expected_snapshot_rows=`1862` target=`stock_realtime_daily_snapshot`
...
- P0 passed realtime_snapshot_subscriptions_present: expected=>0 actual=2373
