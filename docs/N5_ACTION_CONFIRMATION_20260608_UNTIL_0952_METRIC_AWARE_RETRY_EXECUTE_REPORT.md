...
- source_run_guard: {'configured': True, 'allowed_source_run_ids': ['trigger_projection_matcher_execute_20260608_v13_index_all_until_0952_v4_repair_retry'], 'denied_source_run_ids': ['trigger_context_snapshot_20260525_condition_layer_20260522_to_20260525_20260524014029_execute', 'trigger_context_snapshot_20260525_condition_layer_20260522_to_20260525_20260525003855_execute'], 'trigger_run_id': 'trigger_projection_matcher_execute_20260608_v13_index_all_until_0952_v4_repair_retry', 'trigger_run_denied': False, 'trigger_run_not_allowed': False, 'observed_source_run_ids': {'trigger_projection_matcher_execute_20260608_v13_index_all_until_0952_v4_repair_retry': 3920}, 'denied_observed_source_run_ids': [], 'outside_allowlist_source_run_ids': [], 'passed': True}
- pending_only_guard: {'allowed_statuses': ['pending'], 'by_status': {'pending': 3920}, 'total_row_count': 3920, 'pending_count': 3920, 'non_pending_count': 0, 'non_pending_sample': [], 'passed': True}
- blockers: []
...
- output_event_plan: {'ActionEligible': 0, 'ActionBlocked': 119, 'ActionExecuted': 0, 'ActionSkipped': 0}
