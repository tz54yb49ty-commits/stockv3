...
- prev_trade_date / data_trade_date: `20260528`
- expected_previous_day_minute_date: `20260528`
- blocked: `False`
- execute_ready: `True`
...
- market_data_run_id: `market_data_subscription_20260529_condition_layer_20260528_source_20260528_v1`
- source_scope_row_count: `4552`
- candidate_row_count: `5038`
- subscription_row_count: `2643`
- subscription_object_count: `2157`
- required_data_kind_counts: `{'minute_bar_1m': 243, 'previous_day_minute_bar_1m': 243, 'realtime_daily_snapshot': 2157}`
- dedup_ratio: `0.524613`

## Preload Plan

- previous_day_minute_subscription_count: `243`
- previous_day_minute_object_count: `243`
- previous_day_minute_object_count_by_asset_kind: `{'stock': 234, 'index': 0, 'board': 9}`
- previous_day_minute_date_counts: `{'20260528': 243}`
- expected_minute_bar_count_per_object: `240`
- estimated_minute_bar_row_count: `58320`
- estimated_minute_bar_row_count_by_asset_kind: `{'stock': 56160, 'index': 0, 'board': 2160}`
- preload_pull_plan_row_count: `2`

## Source Adapter Plan

- board: adapter=`BoardMarketDataAdapter` subscriptions=`9` objects=`9` previous_day_minute_date=`20260528` expected_minute_bar_rows=`2160`
- stock: adapter=`StockMarketDataAdapter` subscriptions=`234` objects=`234` previous_day_minute_date=`20260528` expected_minute_bar_rows=`56160`
...
- P0 passed previous_day_minute_subscriptions_present: expected=>0 actual=243
- P0 passed previous_day_subscription_trade_date_matches_expected: expected=20260528 actual=matched
- P0 passed expected_previous_day_minute_date_matches_prev_trade_date: expected=20260528 actual=20260528
- P0 passed previous_day_pull_plan_trade_date_matches_expected: expected=20260528 actual=matched
