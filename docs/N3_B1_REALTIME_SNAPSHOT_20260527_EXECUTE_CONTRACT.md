...
- snapshot_run_id: `realtime_snapshot_20260527_market_data_subscription_20260527_condition_layer_20260526_source_20260526_v1`
- source_condition_run_id: `condition_layer_20260526_source_20260526_v1`
- for_trade_date: `20260527`
- expected_row_count: `2181`
- writes_outbox: `False`
...
- stock: objects=`2045` subscriptions=`2045` expected_snapshot_rows=`2045`
...
- board: adapter=`BoardMarketDataAdapter` source_pull_plan_id=`39` objects=`127` expected_rows=`127`
- index: adapter=`IndexMarketDataAdapter` source_pull_plan_id=`42` objects=`9` expected_rows=`9`
- stock: adapter=`StockMarketDataAdapter` source_pull_plan_id=`45` objects=`2045` expected_rows=`2045`
...
- rollback_sql_path: `sql/N3_B1_realtime_snapshot_20260527_rollback.sql`
...
- P0 passed n3_b1_source_run_id_matches_n3_6: expected=market_data_subscription_20260527_condition_layer_20260526_source_20260526_v1 actual=market_data_subscription_20260527_condition_layer_20260526_source_20260526_v1
- P0 passed n3_b1_n3_6_source_p0_zero: expected=P0=0 passed=true actual=P0=0 passed=True
- P0 passed n3_b1_snapshot_run_id_distinct: expected=distinct non-empty snapshot_run_id actual=realtime_snapshot_20260527_market_data_subscription_20260527_condition_layer_20260526_source_20260526_v1
- P0 passed n3_b1_asset_counts_match_n3_6: expected={'stock': 2045, 'index': 9, 'board': 127} actual={'stock': 2045, 'index': 9, 'board': 127}
...
Rollback SQL was generated at `sql/N3_B1_realtime_snapshot_20260527_rollback.sql`. It deletes rows by `source_run_id`, `snapshot_run_id`, and `for_trade_date`; it includes scoped outbox/inbox/checkpoint prechecks and does not modify downstream tables.
