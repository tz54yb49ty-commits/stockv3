...
- market_data_run_id: `market_data_subscription_20260605_condition_layer_20260604_source_20260604_v1`
- source_condition_run_id: `condition_layer_20260604_source_20260604_v1`
- source_trade_date: `20260604`
- for_trade_date: `20260605`
- prev_trade_date / data_trade_date: `20260604`
- expected_previous_day_minute_date: `20260604`
- blocked: `False`
- execute_ready: `True`
...
- market_data_run_id: `market_data_subscription_20260605_condition_layer_20260604_source_20260604_v1`
- source_scope_row_count: `5118`
- candidate_row_count: `5802`
- subscription_row_count: `3073`
- subscription_object_count: `2389`
- required_data_kind_counts: `{'minute_bar_1m': 342, 'previous_day_minute_bar_1m': 342, 'realtime_daily_snapshot': 2389}`
- dedup_ratio: `0.529645`

## Preload Plan

- previous_day_minute_subscription_count: `342`
- previous_day_minute_object_count: `342`
- previous_day_minute_object_count_by_asset_kind: `{'stock': 284, 'index': 2, 'board': 56}`
- previous_day_minute_date_counts: `{'20260604': 342}`
- expected_minute_bar_count_per_object: `240`
- estimated_minute_bar_row_count: `82080`
- estimated_minute_bar_row_count_by_asset_kind: `{'stock': 68160, 'index': 480, 'board': 13440}`
- preload_pull_plan_row_count: `3`

## Source Adapter Plan

- board: adapter=`BoardMarketDataAdapter` subscriptions=`56` objects=`56` previous_day_minute_date=`20260604` expected_minute_bar_rows=`13440`
- index: adapter=`IndexMarketDataAdapter` subscriptions=`2` objects=`2` previous_day_minute_date=`20260604` expected_minute_bar_rows=`480`
- stock: adapter=`StockMarketDataAdapter` subscriptions=`284` objects=`284` previous_day_minute_date=`20260604` expected_minute_bar_rows=`68160`
...
- P0 passed previous_day_minute_subscriptions_present: expected=>0 actual=342
- P0 passed previous_day_subscription_trade_date_matches_expected: expected=20260604 actual=matched
- P0 passed expected_previous_day_minute_date_matches_prev_trade_date: expected=20260604 actual=20260604
- P0 passed previous_day_pull_plan_trade_date_matches_expected: expected=20260604 actual=matched
