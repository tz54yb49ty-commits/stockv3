{
  ...
  "blockers": [],
  "trade_date": "20260623",
  "source_batch_id": "condition_source_activation_20260623_v1",
  "source_versions": {
    "stock_daily_basic": "stock_daily_basic_20260623_v1",
    "stock_financial": "stock_financial_20260623_v1",
    "index_membership": "index_membership_20260623_v1",
    "board_membership": "board_membership_20260623_v1"
  },
  "expected_rows": {
    "stock_daily_basic": 5509,
    "stock_financial": 5509,
    "index_membership": 12841,
    "board_membership": 56962,
    "total": 80821
  },
  "condition_universe_summary": {
    "official_daily_stock_rows": 5509,
    "condition_stock_rows": 5509,
    "official_no_trade_excluded": 17,
  ...
  "baseline": {
    "upstream_daily": {
      "stock_daily": {
        "active_source_version": "stock_daily_20260623_v1",
        "row_count": 5509
      },
      "index_daily": {
        "active_source_version": "index_daily_20260623_v1",
        "row_count": 83
      },
      "board_daily": {
        "active_source_version": "board_daily_20260623_v1",
        "row_count": 427
      }
    },
    ...
    "event_counts": {
      "common_event_outbox": 697165,
      "common_event_inbox": 208345,
      "common_event_consumer_checkpoint": 62049
    }
  },
  "quality": {
    "p0_count": 0,
  ...
  "quality_items": [
    ...
    },
    {
      ...
      "actual_value": "5509",
      "details": {
        "official_daily_bar_universe": 5509,
        "condition_source_gap_manifest_rows": 17
      }
    },
    {
  ...
  "rollback_sql_path": "sql/N1_20260623_source_facts_guarded_runner_rollback.sql",
  "generated_at": "2026-06-23T18:01:16+08:00"
}
