...
- snapshot_subscription_count: `2155`
- snapshot_object_count: `2155`
- expected_snapshot_rows: `2155`
- writes_outbox: `true`
...
- stock: adapter=`StockMarketDataAdapter` objects=`1945` expected_snapshot_rows=`1945` target=`stock_realtime_daily_snapshot`
...
- P0 passed realtime_snapshot_subscriptions_present: expected=>0 actual=2155
