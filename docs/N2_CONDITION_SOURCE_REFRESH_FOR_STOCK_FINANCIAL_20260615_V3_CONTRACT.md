...
```bash
PYTHONPATH=src python3 scripts/run_condition_layer_execute.py --source-trade-date 20260615 --policy configs/n2_policy/default_policy_draft.json --run-id condition_layer_20260615_source_20260615_for_20260616_v4 --execute --overwrite --user-confirmed --operator codex --confirmation-note N2-20260615-stock-financial-v3-refresh-v4-active-supersede --report-path docs/N2_CONDITION_SOURCE_REFRESH_FOR_STOCK_FINANCIAL_20260615_V3_EXECUTE_REPORT.json
```
