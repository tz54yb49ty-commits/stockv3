...
- market_data_run_id: `market_data_subscription_20260525_condition_layer_20260522_to_20260525_20260524014029_execute`
...
- previous_day_minute_date_counts: `{'20260522': 2188}`
...
- board: adapter=`BoardMarketDataAdapter` subscriptions=`127` objects=`127` previous_day_minute_date=`20260522` expected_minute_bar_rows=`30480`
- index: adapter=`IndexMarketDataAdapter` subscriptions=`9` objects=`9` previous_day_minute_date=`20260522` expected_minute_bar_rows=`2160`
- stock: adapter=`StockMarketDataAdapter` subscriptions=`2052` objects=`2052` previous_day_minute_date=`20260522` expected_minute_bar_rows=`492480`
...
- P0 passed previous_day_subscription_trade_date_matches_expected: expected=20260522 actual=matched
- P0 passed expected_previous_day_minute_date_matches_prev_trade_date: expected=20260522 actual=20260522
- P0 passed previous_day_pull_plan_trade_date_matches_expected: expected=20260522 actual=matched
