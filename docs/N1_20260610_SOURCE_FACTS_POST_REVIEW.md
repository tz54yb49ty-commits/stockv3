# N1 20260610 Source Facts Post Review
...
- official batch: `official_daily_ingest_20260610_v1`
- condition batch: `condition_source_activation_20260610_v1`
- combined rows: `86844`
...
```json
{
  "expected": {
    ...
    "condition_source": {
      ...
      "total_condition_source_fact": 80823
    },
...
[
  {
    "batch_id": "condition_source_activation_20260610_v1",
    "trade_date": "20260610",
    "data_domain": "common",
    "data_type": "condition_source_activation",
    "source": "n1.source_facts_20260610.condition_source",
    "source_version": "condition_source_activation_20260610_v1",
    "row_count": 80823,
    "error_count": 0,
    "status": "passed",
    ...
    "rollback_strategy": "sql/N1_20260610_source_facts_guarded_runner_rollback.sql",
    "started_at": "2026-06-10 20:49:09.713573+08:00",
    "finished_at": "2026-06-10 20:49:09.713573+08:00"
  },
  {
    "batch_id": "official_daily_ingest_20260610_v1",
    "trade_date": "20260610",
    "data_domain": "common",
    "data_type": "official_daily",
    "source": "n1.source_facts_20260610.official_daily",
    "source_version": "official_daily_ingest_20260610_v1",
    "row_count": 6021,
    "error_count": 0,
    "status": "passed",
    "quality_gate_summary": {
    ...
    "rollback_strategy": "sql/N1_20260610_source_facts_guarded_runner_rollback.sql",
    "started_at": "2026-06-10 20:48:42.126660+08:00",
    "finished_at": "2026-06-10 20:48:42.126660+08:00"
  }
]
```
...
```json
{
  ...
  "checkpoint_refs": {
    "official_daily_ingest_20260610_v1": 0,
    "condition_source_activation_20260610_v1": 0
  },
  "event_refs_total": 0,
  "downstream_refs": {
...
```json
{
  "path": "sql/N1_20260610_source_facts_guarded_runner_rollback.sql",
  "exists": true,
