{
  ...
  "baseline": {
    ...
    "event_counts": {
      "common_event_outbox": 198944,
      "common_event_inbox": 102484,
      "common_event_consumer_checkpoint": 9335
    }
  },
  "quality": {
    "p0_count": 0,
  ...
  "quality_items": [
    ...
    },
    {
      ...
      "actual_value": "5514",
      "details": {
        "official_daily_bar_universe": 5514,
        "condition_source_gap_manifest_rows": 12
      }
    },
    {
  ...
  "execute_command_template": "PYTHONPATH=src python3 scripts/run_condition_source_activation_20260605_once.py --execute --user-confirmed --postgres-commit-enabled --execute-report-json docs/N1_20260608_SOURCE_FACTS_EXECUTE_REPORT.json --execute-report-md docs/N1_20260608_SOURCE_FACTS_EXECUTE_REPORT.md",
  "side_effects": {
  ...
  "generated_at": "2026-06-09T10:22:20+08:00"
}
