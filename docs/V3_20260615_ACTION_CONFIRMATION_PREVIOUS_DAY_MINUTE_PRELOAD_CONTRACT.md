...
- expected_row_count: `166320`
- writes_outbox: `False`
- P0/P1/P2: `0/0/0`

## Expected Asset Counts

- stock: objects=`693` subscriptions=`693` expected_minute_rows=`166320`
...
- stock: adapter=`StockMarketDataAdapter` source_pull_plan_id=`192` objects=`693` expected_rows=`166320`
...
- rollback_sql_path: `sql/V3_20260615_action_confirmation_previous_day_minute_preload_rollback.sql`
...
- P0 passed n3_a1_source_run_id_matches_n3_6: expected=market_data_subscription_20260615_action_confirmation_previous_day_1005_scope__n4_production_semantic_replay_20260615_market_snapshot_updated_until_1000_v1 actual=market_data_subscription_20260615_action_confirmation_previous_day_1005_scope__n4_production_semantic_replay_20260615_market_snapshot_updated_until_1000_v1
...
- P0 passed n3_a1_preload_run_id_distinct: expected=distinct non-empty preload_run_id actual=previous_day_minute_preload_20260612_for_20260615_action_confirmation_1005_scope__n4_production_semantic_replay_20260615_market_snapshot_updated_until_1000_v1
- P0 passed n3_a1_asset_counts_match_n3_6: expected={'stock': 693, 'index': 0, 'board': 0} actual={'stock': 693, 'index': 0, 'board': 0}
...
Rollback SQL was generated at `sql/V3_20260615_action_confirmation_previous_day_minute_preload_rollback.sql`. It deletes rows by `source_run_id` and `preload_run_id` and does not touch `common_event_outbox`.
