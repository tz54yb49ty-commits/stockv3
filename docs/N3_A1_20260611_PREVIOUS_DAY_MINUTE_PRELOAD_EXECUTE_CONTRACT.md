...
- previous_day_minute_date: `20260610`
- expected_row_count: `67920`
- writes_outbox: `False`
- P0/P1/P2: `0/0/0`

## Expected Asset Counts

- stock: objects=`250` subscriptions=`250` expected_minute_rows=`60000`
- index: objects=`19` subscriptions=`19` expected_minute_rows=`4560`
- board: objects=`14` subscriptions=`14` expected_minute_rows=`3360`
...
- board: adapter=`BoardMarketDataAdapter` source_pull_plan_id=`162` objects=`14` expected_rows=`3360`
- index: adapter=`IndexMarketDataAdapter` source_pull_plan_id=`165` objects=`19` expected_rows=`4560`
- stock: adapter=`StockMarketDataAdapter` source_pull_plan_id=`168` objects=`250` expected_rows=`60000`
...
- rollback_sql_path: `sql/N3_A1_previous_day_minute_20260611_rollback.sql`
...
- P0 passed n3_a1_source_run_id_matches_n3_6: expected=market_data_subscription_20260611_condition_layer_20260610_source_20260610_for_20260611_v1 actual=market_data_subscription_20260611_condition_layer_20260610_source_20260610_for_20260611_v1
- P0 passed n3_a1_n3_6_source_p0_zero: expected=P0=0 passed=true actual=P0=0 passed=True
- P0 passed n3_a1_previous_day_minute_date_matches_prev_trade_date: expected=20260610 actual=20260610
- P0 passed n3_a1_preload_run_id_distinct: expected=distinct non-empty preload_run_id actual=previous_day_minute_preload_20260610_for_20260611__market_data_subscription_20260611_condition_layer_20260610_source_20260610_for_20260611_v1
- P0 passed n3_a1_asset_counts_match_n3_6: expected={'stock': 250, 'index': 19, 'board': 14} actual={'stock': 250, 'index': 19, 'board': 14}
...
Rollback SQL was generated at `sql/N3_A1_previous_day_minute_20260611_rollback.sql`. It deletes rows by `source_run_id` and `preload_run_id` and does not touch `common_event_outbox`.
