...
- candidate_count: 5118
- matched_count: 275
- pending_count: 3034
- not_matched_signal_count: 1809
- P0/P1/P2: 0/1/0

## Match Summary

- matched_by_signal_type: {'B_BUY': 87, 'S_SELL': 188}
- pending_by_signal_type: {'B_BUY': 1552, 'S_SELL': 1482}
- matched_by_trigger_mark_candidate: {'30m_shrink': 188, '30m_volume': 87}
- pending_by_trigger_mark_candidate: {'30m_shrink': 1428, '30m_volume': 1434, 'normal': 172}
- by_legacy_signal_type: {'BUY_HINT': 212, 'B_BUY_30M_VOL': 2389, 'SELL_HINT': 130, 'S_SELL_30M_SHRINK': 2387}
- not_matched_by_projection_signal_status: {'down_volume_expanding': 562, 'down_volume_flat': 330, 'down_volume_shrinking': 201, 'flat': 510, 'up_volume_expanding': 90, 'up_volume_flat': 67, 'up_volume_shrinking': 49}
- buy_hint_matched_count: 4
- sell_hint_matched_count: 9

## Not Ready Summary

- pending_by_not_ready_classification: {'blocked': 3034}
- board_not_ready_object_count: 428
...
- P0 passed n4_projection_matcher_context_run_ready: expected=trigger_context_snapshot_20260605_condition_layer_20260604_source_20260604_v1 actual=trigger_context_snapshot_20260605_condition_layer_20260604_source_20260604_v1
- P0 passed n4_projection_matcher_current_context_not_synthetic: expected=not denylisted actual=False
- P0 passed n4_projection_matcher_context_rows_available: expected=>0 actual=5118
- P0 passed n4_projection_matcher_projection_rows_available: expected=>0 actual=2389
...
- P0 passed n4_projection_matcher_hint_signals_supported: expected=hint signal support present actual=BUY_HINT=4 SELL_HINT=9
...
- P1 warning n4_projection_matcher_board_not_ready_visible: expected=visible if present actual=428
