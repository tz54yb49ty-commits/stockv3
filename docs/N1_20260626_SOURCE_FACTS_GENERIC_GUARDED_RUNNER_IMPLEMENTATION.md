...
- official_daily_batch_id: `official_daily_ingest_20260626_v1`
- condition_source_batch_id: `condition_source_activation_20260626_v1`
...
```json
{
  "path": "sql/N1_20260626_source_facts_guarded_runner_rollback.sql",
...
`N1_20260626_SOURCE_FACTS_EXECUTE_FINAL_GATE_REVIEW`
