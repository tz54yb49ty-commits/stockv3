...
```bash
PYTHONPATH=src:scripts python3 scripts/run_previous_day_minute_preload_execute.py --contract-path docs/N3_A1_previous_day_full_context_minute_preload_expansion_20260603_execute_contract.json --execute --user-confirmed
```
