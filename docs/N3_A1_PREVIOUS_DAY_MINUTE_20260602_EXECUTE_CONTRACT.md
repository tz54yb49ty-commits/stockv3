...
- expected_row_count: `232560`
- writes_outbox: `False`
- P0/P1/P2: `0/0/0`

## Expected Asset Counts

- stock: objects=`765` subscriptions=`765` expected_minute_rows=`183600`
- index: objects=`54` subscriptions=`54` expected_minute_rows=`12960`
- board: objects=`150` subscriptions=`150` expected_minute_rows=`36000`
...
- board: adapter=`BoardMarketDataAdapter` source_pull_plan_id=`81` objects=`150` expected_rows=`36000`
- index: adapter=`IndexMarketDataAdapter` source_pull_plan_id=`84` objects=`54` expected_rows=`12960`
- stock: adapter=`StockMarketDataAdapter` source_pull_plan_id=`87` objects=`765` expected_rows=`183600`
...
- P0 passed n3_a1_source_run_id_matches_n3_6: expected=market_data_subscription_20260602_condition_layer_20260601_source_20260601_v1 actual=market_data_subscription_20260602_condition_layer_20260601_source_20260601_v1
- P0 passed n3_a1_n3_6_source_p0_zero: expected=P0=0 passed=true actual=P0=0 passed=True
- P0 passed n3_a1_previous_day_minute_date_matches_prev_trade_date: expected=20260601 actual=20260601
- P0 passed n3_a1_preload_run_id_distinct: expected=distinct non-empty preload_run_id actual=previous_day_minute_preload_20260602_market_data_subscription_20260602_condition_layer_20260601_source_20260601_v1
- P0 passed n3_a1_asset_counts_match_n3_6: expected={'stock': 765, 'index': 54, 'board': 150} actual={'stock': 765, 'index': 54, 'board': 150}
...
Rollback SQL was generated at `sql/N3_A1_previous_day_minute_20260602_rollback.sql`. It deletes rows by `source_run_id` and `preload_run_id` and does not touch `common_event_outbox`.
