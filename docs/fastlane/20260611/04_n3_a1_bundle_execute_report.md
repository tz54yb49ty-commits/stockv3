...
- objects_processed: `283`
- minute_rows_written: `67920`
- preload_status_rows_written: `283`
...
- stock: objects=`250` minute_rows=`60000` passed=`250` partial=`0` missing=`0` failed=`0`
- index: objects=`19` minute_rows=`4560` passed=`19` partial=`0` missing=`0` failed=`0`
- board: objects=`14` minute_rows=`3360` passed=`14` partial=`0` missing=`0` failed=`0`

## Post Checks

- n3_a1_asset_object_count_matches_a0: `True`
- n3_a1_expected_status_counts: `{'stock': 250, 'index': 19, 'board': 14}`
- n3_a1_actual_status_counts: `{'stock': 250, 'index': 19, 'board': 14}`
- n3_a1_minute_rows_reasonable: `True`
- n3_a1_total_minute_rows_present: `True`
- n3_a1_expected_minute_rows_by_asset: `{'stock': 60000, 'index': 4560, 'board': 3360}`
- n3_a1_actual_minute_rows_by_asset: `{'stock': 60000, 'index': 4560, 'board': 3360}`
...
- n3_a1_object_status_counts: `{'passed': 283}`
...
- n3_a1_global_event_counts_before: `{'common_event_outbox': 198634, 'common_event_inbox': 110805, 'common_event_consumer_checkpoint': 19505}`
- n3_a1_global_event_counts_after: `{'common_event_outbox': 198634, 'common_event_inbox': 110805, 'common_event_consumer_checkpoint': 19505}`
