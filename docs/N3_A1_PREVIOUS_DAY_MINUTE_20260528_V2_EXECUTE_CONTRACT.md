...
- expected_row_count: `76080`
- writes_outbox: `False`
- P0/P1/P2: `0/0/0`

## Expected Asset Counts

- stock: objects=`294` subscriptions=`294` expected_minute_rows=`70560`
- index: objects=`4` subscriptions=`4` expected_minute_rows=`960`
...
- board: adapter=`BoardMarketDataAdapter` source_pull_plan_id=`56` objects=`19` expected_rows=`4560`
- index: adapter=`IndexMarketDataAdapter` source_pull_plan_id=`59` objects=`4` expected_rows=`960`
- stock: adapter=`StockMarketDataAdapter` source_pull_plan_id=`62` objects=`294` expected_rows=`70560`
...
- rollback_sql_path: `sql/N3_A1_previous_day_minute_20260528_v2_rollback.sql`
...
- P0 passed n3_a1_source_run_id_matches_n3_6: expected=market_data_subscription_20260528_condition_layer_20260527_source_20260527_v2 actual=market_data_subscription_20260528_condition_layer_20260527_source_20260527_v2
- P0 passed n3_a1_n3_6_source_p0_zero: expected=P0=0 passed=true actual=P0=0 passed=True
- P0 passed n3_a1_previous_day_minute_date_matches_prev_trade_date: expected=20260527 actual=20260527
- P0 passed n3_a1_preload_run_id_distinct: expected=distinct non-empty preload_run_id actual=previous_day_minute_preload_20260527_for_20260528__market_data_subscription_20260528_condition_layer_20260527_source_20260527_v2
- P0 passed n3_a1_asset_counts_match_n3_6: expected={'stock': 294, 'index': 4, 'board': 19} actual={'stock': 294, 'index': 4, 'board': 19}
...
Rollback SQL was generated at `sql/N3_A1_previous_day_minute_20260528_v2_rollback.sql`. It deletes rows by `source_run_id` and `preload_run_id` and does not touch `common_event_outbox`.
