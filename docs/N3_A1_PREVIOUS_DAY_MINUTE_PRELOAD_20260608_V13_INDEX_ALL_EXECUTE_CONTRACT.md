...
- expected_row_count: `89280`
- writes_outbox: `False`
- P0/P1/P2: `0/0/0`

## Expected Asset Counts

- stock: objects=`353` subscriptions=`353` expected_minute_rows=`84720`
- index: objects=`6` subscriptions=`6` expected_minute_rows=`1440`
- board: objects=`13` subscriptions=`13` expected_minute_rows=`3120`
...
- board: adapter=`BoardMarketDataAdapter` source_pull_plan_id=`138` objects=`13` expected_rows=`3120`
- index: adapter=`IndexMarketDataAdapter` source_pull_plan_id=`141` objects=`6` expected_rows=`1440`
- stock: adapter=`StockMarketDataAdapter` source_pull_plan_id=`144` objects=`353` expected_rows=`84720`
...
- rollback_sql_path: `sql/N3_A1_previous_day_minute_preload_20260608_v13_index_all_rollback.sql`
...
- P0 passed n3_a1_source_run_id_matches_n3_6: expected=market_data_subscription_20260608_condition_layer_20260605_to_20260608_v13_index_all_execute actual=market_data_subscription_20260608_condition_layer_20260605_to_20260608_v13_index_all_execute
...
- P0 passed n3_a1_preload_run_id_distinct: expected=distinct non-empty preload_run_id actual=previous_day_minute_preload_20260605__market_data_subscription_20260608_condition_layer_20260605_to_20260608_v13_index_all_execute
- P0 passed n3_a1_asset_counts_match_n3_6: expected={'stock': 353, 'index': 6, 'board': 13} actual={'stock': 353, 'index': 6, 'board': 13}
...
Rollback SQL was generated at `sql/N3_A1_previous_day_minute_preload_20260608_v13_index_all_rollback.sql`. It deletes rows by `source_run_id` and `preload_run_id` and does not touch `common_event_outbox`.
