...
- expected_row_count: `84240`
- writes_outbox: `False`
- P0/P1/P2: `0/0/0`

## Expected Asset Counts

- stock: objects=`289` subscriptions=`289` expected_minute_rows=`69360`
- index: objects=`51` subscriptions=`51` expected_minute_rows=`12240`
- board: objects=`11` subscriptions=`11` expected_minute_rows=`2640`
...
- board: adapter=`BoardMarketDataAdapter` source_pull_plan_id=`147` objects=`11` expected_rows=`2640`
- index: adapter=`IndexMarketDataAdapter` source_pull_plan_id=`150` objects=`51` expected_rows=`12240`
- stock: adapter=`StockMarketDataAdapter` source_pull_plan_id=`153` objects=`289` expected_rows=`69360`
...
- rollback_sql_path: `sql/N3_A1_previous_day_minute_20260609_rollback.sql`
...
- P0 passed n3_a1_source_run_id_matches_n3_6: expected=market_data_subscription_20260609_condition_layer_20260608_source_20260608_for_20260609_v1 actual=market_data_subscription_20260609_condition_layer_20260608_source_20260608_for_20260609_v1
- P0 passed n3_a1_n3_6_source_p0_zero: expected=P0=0 passed=true actual=P0=0 passed=True
- P0 passed n3_a1_previous_day_minute_date_matches_prev_trade_date: expected=20260608 actual=20260608
- P0 passed n3_a1_preload_run_id_distinct: expected=distinct non-empty preload_run_id actual=previous_day_minute_preload_20260608_for_20260609__market_data_subscription_20260609_condition_layer_20260608_source_20260608_for_20260609_v1
- P0 passed n3_a1_asset_counts_match_n3_6: expected={'stock': 289, 'index': 51, 'board': 11} actual={'stock': 289, 'index': 51, 'board': 11}
- P0 passed n3_a1_source_adapter_plan_covers_assets: expected=stock,index,board actual=stock,index,board
...
Rollback SQL was generated at `sql/N3_A1_previous_day_minute_20260609_rollback.sql`. It deletes rows by `source_run_id` and `preload_run_id` and does not touch `common_event_outbox`.

### 20260609 Staged Rollback Scope

This 20260609 staged route already executed Stage 1 subscription control-row registration. The scoped rollback SQL has been repaired to cover both:

- Stage 2 A1 preload rows for `preload_run_id`
- Stage 1 subscription control rows for `source_run_id` / `source_subscription_run_id`

The hard-fail guard checks event infra, N3-B/C/B2, N4/N5/N6, downstream flags, and worker flags before the first executable `DELETE`.
