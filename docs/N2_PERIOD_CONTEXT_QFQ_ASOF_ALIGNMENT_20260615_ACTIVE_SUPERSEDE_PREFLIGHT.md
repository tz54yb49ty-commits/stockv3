# N2 Period Context QFQ As-Of Alignment 20260615 Active Supersede Preflight
...
- execute_allowed: `false` before user confirmation
- blocked_reasons: `user_confirmation_required`
- target_run_baseline_rows: `0`
- event_refs: `0/0/0`
- downstream_refs: `0/0/0/0`
