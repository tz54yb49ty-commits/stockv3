...
- prev_trade_date / data_trade_date: `20260526`
- expected_previous_day_minute_date: `20260526`
- blocked: `False`
- execute_ready: `True`
...
- market_data_run_id: `market_data_subscription_20260527_condition_layer_20260526_source_20260526_v1`
- source_scope_row_count: `4574`
- candidate_row_count: `13722`
- subscription_row_count: `6543`
- subscription_object_count: `2181`
- required_data_kind_counts: `{'minute_bar_1m': 2181, 'previous_day_minute_bar_1m': 2181, 'realtime_daily_snapshot': 2181}`
- dedup_ratio: `0.476826`

## Preload Plan

- previous_day_minute_subscription_count: `2181`
- previous_day_minute_object_count: `2181`
- previous_day_minute_object_count_by_asset_kind: `{'stock': 2045, 'index': 9, 'board': 127}`
- previous_day_minute_date_counts: `{'20260526': 2181}`
- expected_minute_bar_count_per_object: `240`
- estimated_minute_bar_row_count: `523440`
- estimated_minute_bar_row_count_by_asset_kind: `{'stock': 490800, 'index': 2160, 'board': 30480}`
- preload_pull_plan_row_count: `3`

## Source Adapter Plan

- board: adapter=`BoardMarketDataAdapter` subscriptions=`127` objects=`127` previous_day_minute_date=`20260526` expected_minute_bar_rows=`30480`
- index: adapter=`IndexMarketDataAdapter` subscriptions=`9` objects=`9` previous_day_minute_date=`20260526` expected_minute_bar_rows=`2160`
- stock: adapter=`StockMarketDataAdapter` subscriptions=`2045` objects=`2045` previous_day_minute_date=`20260526` expected_minute_bar_rows=`490800`
...
- P0 passed previous_day_minute_subscriptions_present: expected=>0 actual=2181
- P0 passed previous_day_subscription_trade_date_matches_expected: expected=20260526 actual=matched
- P0 passed expected_previous_day_minute_date_matches_prev_trade_date: expected=20260526 actual=20260526
- P0 passed previous_day_pull_plan_trade_date_matches_expected: expected=20260526 actual=matched
