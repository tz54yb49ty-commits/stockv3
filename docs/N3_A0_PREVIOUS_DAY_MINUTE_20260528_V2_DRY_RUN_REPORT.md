...
- market_data_run_id: `market_data_subscription_20260528_condition_layer_20260527_source_20260527_v2`
- source_condition_run_id: `condition_layer_20260527_source_20260527_v2`
- source_trade_date: `20260527`
- for_trade_date: `20260528`
- prev_trade_date / data_trade_date: `20260527`
- expected_previous_day_minute_date: `20260527`
- blocked: `False`
- execute_ready: `True`
...
- market_data_run_id: `market_data_subscription_20260528_condition_layer_20260527_source_20260527_v2`
- source_scope_row_count: `4602`
- candidate_row_count: `5236`
- subscription_row_count: `2780`
- subscription_object_count: `2146`
- required_data_kind_counts: `{'minute_bar_1m': 317, 'previous_day_minute_bar_1m': 317, 'realtime_daily_snapshot': 2146}`
- dedup_ratio: `0.53094`

## Preload Plan

- previous_day_minute_subscription_count: `317`
- previous_day_minute_object_count: `317`
- previous_day_minute_object_count_by_asset_kind: `{'stock': 294, 'index': 4, 'board': 19}`
- previous_day_minute_date_counts: `{'20260527': 317}`
- expected_minute_bar_count_per_object: `240`
- estimated_minute_bar_row_count: `76080`
- estimated_minute_bar_row_count_by_asset_kind: `{'stock': 70560, 'index': 960, 'board': 4560}`
- preload_pull_plan_row_count: `3`

## Source Adapter Plan

- board: adapter=`BoardMarketDataAdapter` subscriptions=`19` objects=`19` previous_day_minute_date=`20260527` expected_minute_bar_rows=`4560`
- index: adapter=`IndexMarketDataAdapter` subscriptions=`4` objects=`4` previous_day_minute_date=`20260527` expected_minute_bar_rows=`960`
- stock: adapter=`StockMarketDataAdapter` subscriptions=`294` objects=`294` previous_day_minute_date=`20260527` expected_minute_bar_rows=`70560`
...
- P0 passed previous_day_minute_subscriptions_present: expected=>0 actual=317
- P0 passed previous_day_subscription_trade_date_matches_expected: expected=20260527 actual=matched
- P0 passed expected_previous_day_minute_date_matches_prev_trade_date: expected=20260527 actual=20260527
- P0 passed previous_day_pull_plan_trade_date_matches_expected: expected=20260527 actual=matched
