# V3 20260615 C1 Action-Confirmation Scope Subscription Control Preflight
...
- trace-preserving scoped execute wrapper: `scripts/run_v3_20260615_c1_action_confirmation_scope_subscription_execute.py`
- source_trigger_match refs persist under control-row `raw_json.source_trace`.
