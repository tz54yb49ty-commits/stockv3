...
- expected_row_count: `515040`
- writes_outbox: `False`
- P0/P1/P2: `0/0/0`

## Expected Asset Counts

- stock: objects=`2010` subscriptions=`2010` expected_minute_rows=`482400`
...
- board: adapter=`BoardMarketDataAdapter` source_pull_plan_id=`47` objects=`127` expected_rows=`30480`
- index: adapter=`IndexMarketDataAdapter` source_pull_plan_id=`50` objects=`9` expected_rows=`2160`
- stock: adapter=`StockMarketDataAdapter` source_pull_plan_id=`53` objects=`2010` expected_rows=`482400`
...
- rollback_sql_path: `sql/N3_A1_previous_day_minute_20260528_rollback.sql`
...
- P0 passed n3_a1_source_run_id_matches_n3_6: expected=market_data_subscription_20260528_condition_layer_20260527_source_20260527_v1 actual=market_data_subscription_20260528_condition_layer_20260527_source_20260527_v1
...
- P0 passed n3_a1_preload_run_id_distinct: expected=distinct non-empty preload_run_id actual=previous_day_minute_preload_20260527_for_20260528__market_data_subscription_20260528_condition_layer_20260527_source_20260527_v1
- P0 passed n3_a1_asset_counts_match_n3_6: expected={'stock': 2010, 'index': 9, 'board': 127} actual={'stock': 2010, 'index': 9, 'board': 127}
...
Rollback SQL was generated at `sql/N3_A1_previous_day_minute_20260528_rollback.sql`. It deletes rows by `source_run_id` and `preload_run_id` and does not touch `common_event_outbox`.
