...
- board: adapter=`BoardMarketDataAdapter` source_pull_plan_id=`57` objects=`127` expected_rows=`127`
- index: adapter=`IndexMarketDataAdapter` source_pull_plan_id=`60` objects=`9` expected_rows=`9`
- stock: adapter=`StockMarketDataAdapter` source_pull_plan_id=`63` objects=`2010` expected_rows=`2010`
...
- rollback_sql_path: `sql/N3_B1_realtime_snapshot_20260528_v2_rollback.sql`
...
- P0 passed n3_b1_source_run_id_matches_n3_6: expected=market_data_subscription_20260528_condition_layer_20260527_source_20260527_v2 actual=market_data_subscription_20260528_condition_layer_20260527_source_20260527_v2
- P0 passed n3_b1_n3_6_source_p0_zero: expected=P0=0 passed=true actual=P0=0 passed=True
- P0 passed n3_b1_snapshot_run_id_distinct: expected=distinct non-empty snapshot_run_id actual=realtime_snapshot_20260528_market_data_subscription_20260528_condition_layer_20260527_source_20260527_v2
...
Rollback SQL was generated at `sql/N3_B1_realtime_snapshot_20260528_v2_rollback.sql`. It deletes rows by `source_run_id`, `snapshot_run_id`, and `for_trade_date`; it includes scoped outbox/inbox/checkpoint prechecks and does not modify downstream tables.
