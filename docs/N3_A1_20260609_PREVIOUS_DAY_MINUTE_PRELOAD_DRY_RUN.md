...
- market_data_run_id: `market_data_subscription_20260609_condition_layer_20260608_source_20260608_for_20260609_v1`
...
- prev_trade_date / data_trade_date: `20260608`
- expected_previous_day_minute_date: `20260608`
- blocked: `False`
- execute_ready: `True`
...
- market_data_run_id: `market_data_subscription_20260609_condition_layer_20260608_source_20260608_for_20260609_v1`
- source_scope_row_count: `4524`
- candidate_row_count: `5226`
- subscription_row_count: `2792`
- subscription_object_count: `2090`
- required_data_kind_counts: `{'minute_bar_1m': 351, 'previous_day_minute_bar_1m': 351, 'realtime_daily_snapshot': 2090}`
- dedup_ratio: `0.534252`

## Preload Plan

- previous_day_minute_subscription_count: `351`
- previous_day_minute_object_count: `351`
- previous_day_minute_object_count_by_asset_kind: `{'stock': 289, 'index': 51, 'board': 11}`
- previous_day_minute_date_counts: `{'20260608': 351}`
- expected_minute_bar_count_per_object: `240`
- estimated_minute_bar_row_count: `84240`
- estimated_minute_bar_row_count_by_asset_kind: `{'stock': 69360, 'index': 12240, 'board': 2640}`
- preload_pull_plan_row_count: `3`

## Source Adapter Plan

- board: adapter=`BoardMarketDataAdapter` subscriptions=`11` objects=`11` previous_day_minute_date=`20260608` expected_minute_bar_rows=`2640`
- index: adapter=`IndexMarketDataAdapter` subscriptions=`51` objects=`51` previous_day_minute_date=`20260608` expected_minute_bar_rows=`12240`
- stock: adapter=`StockMarketDataAdapter` subscriptions=`289` objects=`289` previous_day_minute_date=`20260608` expected_minute_bar_rows=`69360`
...
- P0 passed previous_day_minute_subscriptions_present: expected=>0 actual=351
- P0 passed previous_day_subscription_trade_date_matches_expected: expected=20260608 actual=matched
- P0 passed expected_previous_day_minute_date_matches_prev_trade_date: expected=20260608 actual=20260608
- P0 passed previous_day_pull_plan_trade_date_matches_expected: expected=20260608 actual=matched
