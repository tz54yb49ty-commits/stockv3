...
- candidate_row_count: `13806`
- subscription_row_count: `6438`
- subscription_object_count: `2146`
- required_data_kind_counts: `{'minute_bar_1m': 2146, 'previous_day_minute_bar_1m': 2146, 'realtime_daily_snapshot': 2146}`
- dedup_ratio: `0.466319`

## Preload Plan

- previous_day_minute_subscription_count: `2146`
- previous_day_minute_object_count: `2146`
- previous_day_minute_object_count_by_asset_kind: `{'stock': 2010, 'index': 9, 'board': 127}`
- previous_day_minute_date_counts: `{'20260527': 2146}`
- expected_minute_bar_count_per_object: `240`
- estimated_minute_bar_row_count: `515040`
- estimated_minute_bar_row_count_by_asset_kind: `{'stock': 482400, 'index': 2160, 'board': 30480}`
- preload_pull_plan_row_count: `3`

## Source Adapter Plan

- board: adapter=`BoardMarketDataAdapter` subscriptions=`127` objects=`127` previous_day_minute_date=`20260527` expected_minute_bar_rows=`30480`
- index: adapter=`IndexMarketDataAdapter` subscriptions=`9` objects=`9` previous_day_minute_date=`20260527` expected_minute_bar_rows=`2160`
- stock: adapter=`StockMarketDataAdapter` subscriptions=`2010` objects=`2010` previous_day_minute_date=`20260527` expected_minute_bar_rows=`482400`
...
- P0 passed previous_day_minute_subscriptions_present: expected=>0 actual=2146
