...
- snapshot_subscription_count: `2474`
- snapshot_object_count: `2474`
- expected_snapshot_rows: `2474`
- writes_outbox: `false`
...
- stock: adapter=`StockMarketDataAdapter` objects=`1963` expected_snapshot_rows=`1963` target=`stock_realtime_daily_snapshot`
...
- P0 passed realtime_snapshot_subscriptions_present: expected=>0 actual=2474
