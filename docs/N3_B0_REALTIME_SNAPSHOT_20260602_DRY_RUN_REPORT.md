...
- snapshot_subscription_count: `2487`
- snapshot_object_count: `2487`
- expected_snapshot_rows: `2487`
- writes_outbox: `false`
...
- stock: adapter=`StockMarketDataAdapter` objects=`1976` expected_snapshot_rows=`1976` target=`stock_realtime_daily_snapshot`
...
- P0 passed realtime_snapshot_subscriptions_present: expected=>0 actual=2487
