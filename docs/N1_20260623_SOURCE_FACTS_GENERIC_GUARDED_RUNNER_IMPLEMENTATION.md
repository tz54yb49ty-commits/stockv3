...
- official_daily_batch_id: `official_daily_ingest_20260623_v1`
- condition_source_batch_id: `condition_source_activation_20260623_v1`
...
```json
{
  "path": "sql/N1_20260623_source_facts_guarded_runner_rollback.sql",
...
`N1_20260623_SOURCE_FACTS_EXECUTE_FINAL_GATE_REVIEW`
