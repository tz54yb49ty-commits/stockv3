...
- source_run_guard: {'configured': True, 'allowed_source_run_ids': ['trigger_projection_matcher_execute_20260608_until_1500_unified_output_retry'], 'denied_source_run_ids': ['trigger_context_snapshot_20260525_condition_layer_20260522_to_20260525_20260524014029_execute', 'trigger_context_snapshot_20260525_condition_layer_20260522_to_20260525_20260525003855_execute'], 'trigger_run_id': 'trigger_projection_matcher_execute_20260608_until_1500_unified_output_retry', 'trigger_run_denied': False, 'trigger_run_not_allowed': False, 'observed_source_run_ids': {'trigger_projection_matcher_execute_20260608_until_1500_unified_output_retry': 200}, 'denied_observed_source_run_ids': [], 'outside_allowlist_source_run_ids': [], 'passed': True}
- pending_only_guard: {'allowed_statuses': ['pending'], 'by_status': {'pending': 200}, 'total_row_count': 200, 'pending_count': 200, 'non_pending_count': 0, 'non_pending_sample': [], 'passed': True}
- blockers: []
...
- output_event_plan: {'ActionEligible': 0, 'ActionBlocked': 199, 'ActionExecuted': 1, 'ActionSkipped': 0}
