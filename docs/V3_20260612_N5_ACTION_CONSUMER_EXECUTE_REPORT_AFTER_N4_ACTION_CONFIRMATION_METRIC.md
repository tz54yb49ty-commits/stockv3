...
- source_run_guard: {'configured': True, 'allowed_source_run_ids': ['v3_n4_action_confirmation_metric_20260612_after_realtime_virtual_metric_writer_v1'], 'denied_source_run_ids': ['trigger_context_snapshot_20260525_condition_layer_20260522_to_20260525_20260524014029_execute', 'trigger_context_snapshot_20260525_condition_layer_20260522_to_20260525_20260525003855_execute'], 'trigger_run_id': 'v3_n4_action_confirmation_metric_20260612_after_realtime_virtual_metric_writer_v1', 'trigger_run_denied': False, 'trigger_run_not_allowed': False, 'observed_source_run_ids': {'v3_n4_action_confirmation_metric_20260612_after_realtime_virtual_metric_writer_v1': 4454}, 'denied_observed_source_run_ids': [], 'outside_allowlist_source_run_ids': [], 'passed': True}
- pending_only_guard: {'allowed_statuses': ['pending'], 'by_status': {'pending': 4454}, 'total_row_count': 4454, 'pending_count': 4454, 'non_pending_count': 0, 'non_pending_sample': [], 'passed': True}
- blockers: []
...
- output_event_plan: {'ActionEligible': 0, 'ActionBlocked': 0, 'ActionExecuted': 43, 'ActionSkipped': 0}
