...
- board: adapter=`BoardMarketDataAdapter` source_pull_plan_id=`105` objects=`36` expected_rows=`8640`
- index: adapter=`IndexMarketDataAdapter` source_pull_plan_id=`108` objects=`2` expected_rows=`480`
- stock: adapter=`StockMarketDataAdapter` source_pull_plan_id=`111` objects=`284` expected_rows=`68160`
...
- P0 passed n3_a1_source_run_id_matches_n3_6: expected=market_data_subscription_20260604_condition_layer_20260603_source_20260603_v1 actual=market_data_subscription_20260604_condition_layer_20260603_source_20260603_v1
- P0 passed n3_a1_n3_6_source_p0_zero: expected=P0=0 passed=true actual=P0=0 passed=True
- P0 passed n3_a1_previous_day_minute_date_matches_prev_trade_date: expected=20260603 actual=20260603
- P0 passed n3_a1_preload_run_id_distinct: expected=distinct non-empty preload_run_id actual=previous_day_minute_preload_20260603_for_20260604__market_data_subscription_20260604_condition_layer_20260603_source_20260603_v1
- P0 passed n3_a1_asset_counts_match_n3_6: expected={'stock': 284, 'index': 2, 'board': 36} actual={'stock': 284, 'index': 2, 'board': 36}
...
Rollback SQL was generated at `sql/N3_A1_previous_day_minute_20260604_rollback.sql`. It deletes rows by `source_run_id` and `preload_run_id` and does not touch `common_event_outbox`.
