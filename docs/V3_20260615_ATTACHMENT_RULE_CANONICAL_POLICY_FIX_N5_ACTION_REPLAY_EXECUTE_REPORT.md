...
- source_trigger_run_id: v3_n4_trigger_replay_20260615_attachment_rule_canonical_policy_fix_v1
- action_run_id: v3_n5_action_replay_20260615_attachment_rule_canonical_policy_fix_v1
- consumer_name: v3_n5_action_replay_20260615_attachment_rule_canonical_policy_fix_consumer_v1
- execute: True
- user_confirmed: True
- P0/P1/P2: 0/0/0
- allow_execute: True
...
- source_run_guard: {'configured': True, 'allowed_source_run_ids': ['v3_n4_trigger_replay_20260615_attachment_rule_canonical_policy_fix_v1'], 'denied_source_run_ids': [], 'trigger_run_id': 'v3_n4_trigger_replay_20260615_attachment_rule_canonical_policy_fix_v1', 'trigger_run_denied': False, 'trigger_run_not_allowed': False, 'observed_source_run_ids': {'v3_n4_trigger_replay_20260615_attachment_rule_canonical_policy_fix_v1': 6074}, 'denied_observed_source_run_ids': [], 'outside_allowlist_source_run_ids': [], 'passed': True}
- pending_only_guard: {'allowed_statuses': ['pending'], 'by_status': {'pending': 6074}, 'total_row_count': 6074, 'pending_count': 6074, 'non_pending_count': 0, 'non_pending_sample': [], 'passed': True}
- blockers: []
...
- stock_action_fact: 5240
- index_action_fact: 316
- board_action_fact: 518
- common_action_event: 6074
- common_event_outbox: 6074
- common_event_inbox: 6074
- common_event_consumer_checkpoint: 866
- common_position_state: 0
- common_position_event: 0

## Event Mapping

- output_event_plan: {'ActionEligible': 0, 'ActionBlocked': 3076, 'ActionExecuted': 2998, 'ActionSkipped': 0}
