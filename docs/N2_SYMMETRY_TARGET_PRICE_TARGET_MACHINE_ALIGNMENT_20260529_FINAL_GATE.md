# N2 Symmetry Target Price 20260529 v3 Active Supersede Final Gate
...
```bash
PYTHONPATH=src python3 scripts/run_condition_layer_execute.py --source-trade-date 20260529 --policy configs/n2_policy/default_policy_draft.json --run-id condition_layer_20260529_source_20260529_v3 --execute --user-confirmed --overwrite --operator codex --confirmation-note N2-20260529-symmetry-target-price-target-machine-alignment-v3 --report-path docs/N2_symmetry_target_price_target_machine_alignment_20260529_v3_execute_report.json
```
