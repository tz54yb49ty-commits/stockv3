...
- preload_run_id: `previous_day_minute_preload_20260602_for_20260603_full_context_expansion__market_data_subscription_20260603_full_context_expansion_condition_layer_20260602_source_20260602_v1`
...
- expected_row_count: `527280`
- writes_outbox: `False`
- P0/P1/P2: `0/0/0`

## Expected Asset Counts

- stock: objects=`1722` subscriptions=`1722` expected_minute_rows=`413280`
- index: objects=`81` subscriptions=`81` expected_minute_rows=`19440`
- board: objects=`394` subscriptions=`394` expected_minute_rows=`94560`
...
- board: adapter=`BoardMarketDataAdapter` source_pull_plan_id=`103` objects=`394` expected_rows=`94560`
- index: adapter=`IndexMarketDataAdapter` source_pull_plan_id=`102` objects=`81` expected_rows=`19440`
- stock: adapter=`StockMarketDataAdapter` source_pull_plan_id=`101` objects=`1722` expected_rows=`413280`
...
- rollback_sql_path: `sql/N3_A1_previous_day_full_context_minute_preload_expansion_20260603_rollback.sql`
...
- P0 passed n3_a1_source_run_id_matches_n3_6: expected=market_data_subscription_20260603_full_context_expansion_condition_layer_20260602_source_20260602_v1 actual=market_data_subscription_20260603_full_context_expansion_condition_layer_20260602_source_20260602_v1
- P0 passed n3_a1_n3_6_source_p0_zero: expected=P0=0 passed=true actual=P0=0 passed=True
- P0 passed n3_a1_previous_day_minute_date_matches_prev_trade_date: expected=20260602 actual=20260602
- P0 passed n3_a1_preload_run_id_distinct: expected=distinct non-empty preload_run_id actual=previous_day_minute_preload_20260602_for_20260603_full_context_expansion__market_data_subscription_20260603_full_context_expansion_condition_layer_20260602_source_20260602_v1
- P0 passed n3_a1_asset_counts_match_n3_6: expected={'stock': 1722, 'index': 81, 'board': 394} actual={'stock': 1722, 'index': 81, 'board': 394}
...
Rollback SQL was generated at `sql/N3_A1_previous_day_full_context_minute_preload_expansion_20260603_rollback.sql`. It deletes rows by `source_run_id` and `preload_run_id` and does not touch `common_event_outbox`.
