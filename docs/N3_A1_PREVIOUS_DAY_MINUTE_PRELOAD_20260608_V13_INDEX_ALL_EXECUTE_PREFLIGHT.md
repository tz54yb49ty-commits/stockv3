...
```bash
PYTHONPATH=src:scripts python3 scripts/run_previous_day_minute_preload_execute.py --contract-path docs/N3_A1_previous_day_minute_preload_20260608_v13_index_all_execute_contract.json --execute --user-confirmed
```
