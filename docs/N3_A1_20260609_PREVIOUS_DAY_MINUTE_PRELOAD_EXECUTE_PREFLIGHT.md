...
```bash
PYTHONPATH=src:scripts python3 scripts/run_previous_day_minute_preload_execute.py --contract-path docs/N3_A1_20260609_PREVIOUS_DAY_MINUTE_PRELOAD_EXECUTE_CONTRACT.json --historical-preload --source-subscription-run-id market_data_subscription_20260609_condition_layer_20260608_source_20260608_for_20260609_v1 --preload-run-id previous_day_minute_preload_20260608_for_20260609__market_data_subscription_20260609_condition_layer_20260608_source_20260608_for_20260609_v1 --data-trade-date 20260608 --execute --user-confirmed
```
...
- covers_stage1_subscription_control_rows: `true`
- covers_stage2_a1_preload_rows: `true`
- hard_fail_before_first_delete: `true`
- forbidden_event_infra_dml: `true`
