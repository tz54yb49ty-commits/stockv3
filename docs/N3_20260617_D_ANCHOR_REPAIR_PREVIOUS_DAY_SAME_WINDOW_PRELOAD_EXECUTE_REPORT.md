...
- source_run_id: `market_data_subscription_20260617_condition_layer_20260616_source_20260616_for_20260617_d_anchor_repair_v1`
- preload_run_id: `previous_day_same_window_preload_20260616_for_20260617__market_data_subscription_20260617_condition_layer_20260616_source_20260616_for_20260617_d_anchor_repair_v1`
- previous_day_minute_date: `20260616`
- objects_processed: `2049`
- minute_rows_written: `491760`
- preload_status_rows_written: `2049`
...
- stock: objects=`1841` minute_rows=`441840` passed=`1841` partial=`0` missing=`0` failed=`0`
- index: objects=`81` minute_rows=`19440` passed=`81` partial=`0` missing=`0` failed=`0`
- board: objects=`127` minute_rows=`30480` passed=`127` partial=`0` missing=`0` failed=`0`

## Post Checks

- n3_a1_asset_object_count_matches_a0: `True`
- n3_a1_expected_status_counts: `{'stock': 1841, 'index': 81, 'board': 127}`
- n3_a1_actual_status_counts: `{'stock': 1841, 'index': 81, 'board': 127}`
- n3_a1_minute_rows_reasonable: `True`
- n3_a1_total_minute_rows_present: `True`
- n3_a1_expected_minute_rows_by_asset: `{'stock': 441840, 'index': 19440, 'board': 30480}`
- n3_a1_actual_minute_rows_by_asset: `{'stock': 441840, 'index': 19440, 'board': 30480}`
...
- n3_a1_object_status_counts: `{'passed': 2049}`
