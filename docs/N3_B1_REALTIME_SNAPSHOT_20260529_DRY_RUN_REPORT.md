...
- snapshot_subscription_count: `2157`
- snapshot_object_count: `2157`
- expected_snapshot_rows: `2157`
- writes_outbox: `false`
...
- stock: adapter=`StockMarketDataAdapter` objects=`2021` expected_snapshot_rows=`2021` target=`stock_realtime_daily_snapshot`
...
- P0 passed realtime_snapshot_subscriptions_present: expected=>0 actual=2157
