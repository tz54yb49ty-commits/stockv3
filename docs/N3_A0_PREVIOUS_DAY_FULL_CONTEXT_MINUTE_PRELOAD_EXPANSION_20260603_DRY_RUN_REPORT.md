...
- prev_trade_date / data_trade_date: `20260602`
- expected_previous_day_minute_date: `20260602`
- blocked: `False`
- execute_ready: `True`
...
- market_data_run_id: `market_data_subscription_20260603_full_context_expansion_condition_layer_20260602_source_20260602_v1`
- source_scope_row_count: `4391`
- candidate_row_count: `4391`
- subscription_row_count: `2197`
- subscription_object_count: `2197`
- required_data_kind_counts: `{'minute_bar_1m': 2197, 'previous_day_minute_bar_1m': 2197}`
- dedup_ratio: `0.500342`

## Preload Plan

- previous_day_minute_subscription_count: `2197`
- previous_day_minute_object_count: `2197`
- previous_day_minute_object_count_by_asset_kind: `{'stock': 1722, 'index': 81, 'board': 394}`
- previous_day_minute_date_counts: `{'20260602': 2197}`
- expected_minute_bar_count_per_object: `240`
- estimated_minute_bar_row_count: `527280`
- estimated_minute_bar_row_count_by_asset_kind: `{'stock': 413280, 'index': 19440, 'board': 94560}`
- preload_pull_plan_row_count: `3`

## Source Adapter Plan

- board: adapter=`BoardMarketDataAdapter` subscriptions=`394` objects=`394` previous_day_minute_date=`20260602` expected_minute_bar_rows=`94560`
- index: adapter=`IndexMarketDataAdapter` subscriptions=`81` objects=`81` previous_day_minute_date=`20260602` expected_minute_bar_rows=`19440`
- stock: adapter=`StockMarketDataAdapter` subscriptions=`1722` objects=`1722` previous_day_minute_date=`20260602` expected_minute_bar_rows=`413280`
...
- P0 passed previous_day_minute_subscriptions_present: expected=>0 actual=2197
- P0 passed previous_day_subscription_trade_date_matches_expected: expected=20260602 actual=matched
- P0 passed expected_previous_day_minute_date_matches_prev_trade_date: expected=20260602 actual=20260602
- P0 passed previous_day_pull_plan_trade_date_matches_expected: expected=20260602 actual=matched
