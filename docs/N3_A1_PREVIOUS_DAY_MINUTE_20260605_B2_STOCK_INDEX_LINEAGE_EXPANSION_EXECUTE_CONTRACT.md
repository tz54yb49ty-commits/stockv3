...
- preload_run_id: `previous_day_minute_preload_20260604_for_20260605_b2_stock_index_lineage_expansion__market_data_subscription_20260605_b2_stock_index_lineage_expansion_condition_layer_20260604_source_20260604_v1`
...
- expected_row_count: `402000`
- writes_outbox: `False`
- P0/P1/P2: `0/1/0`

## Expected Asset Counts

- stock: objects=`1668` subscriptions=`1668` expected_minute_rows=`400320`
...
Board tables remain in the allowed physical-table family, but board expected rows are `0`.
...
- B2 execute
- N4/N5/N6
- worker / old system / delivery / push / voice / mobile / sim / position / real trade

## Source Adapter Plan

- index: adapter=`IndexMarketDataAdapter` source_pull_plan_id=`123` objects=`7` expected_rows=`1680`
- stock: adapter=`StockMarketDataAdapter` source_pull_plan_id=`125` objects=`1668` expected_rows=`400320`
...
- rollback_sql_path: `sql/N3_A1_previous_day_minute_20260605_b2_stock_index_lineage_expansion_rollback.sql`
...
- P1 warning n3_a1_a0_p1_carried: expected=0 actual=1
- P0 passed n3_a1_source_run_id_matches_n3_6: expected=market_data_subscription_20260605_b2_stock_index_lineage_expansion_condition_layer_20260604_source_20260604_v1 actual=market_data_subscription_20260605_b2_stock_index_lineage_expansion_condition_layer_20260604_source_20260604_v1
- P0 passed n3_a1_n3_6_source_p0_zero: expected=P0=0 passed=true actual=P0=0 passed=True
- P0 passed n3_a1_previous_day_minute_date_matches_prev_trade_date: expected=20260604 actual=20260604
- P0 passed n3_a1_preload_run_id_distinct: expected=distinct non-empty preload_run_id actual=previous_day_minute_preload_20260604_for_20260605_b2_stock_index_lineage_expansion__market_data_subscription_20260605_b2_stock_index_lineage_expansion_condition_layer_20260604_source_20260604_v1
- P0 passed n3_a1_asset_counts_match_n3_6: expected={'stock': 1668, 'index': 7, 'board': 0} actual={'stock': 1668, 'index': 7, 'board': 0}
- P0 passed n3_a1_source_adapter_plan_covers_assets: expected=stock,index actual=stock,index
...
Rollback SQL was generated at `sql/N3_A1_previous_day_minute_20260605_b2_stock_index_lineage_expansion_rollback.sql`. It deletes rows by `source_run_id` and `preload_run_id` and does not touch `common_event_outbox`.
