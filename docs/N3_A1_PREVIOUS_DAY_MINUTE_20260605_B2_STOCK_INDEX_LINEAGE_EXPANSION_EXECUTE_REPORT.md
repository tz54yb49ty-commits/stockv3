...
- objects_processed: `1675`
- minute_rows_written: `402000`
- preload_status_rows_written: `1675`
...
- stock: objects=`1668` minute_rows=`400320` passed=`1668` partial=`0` missing=`0` failed=`0`
- index: objects=`7` minute_rows=`1680` passed=`7` partial=`0` missing=`0` failed=`0`
- board: objects=`0` minute_rows=`0` passed=`0` partial=`0` missing=`0` failed=`0`

## Post Checks

- n3_a1_asset_object_count_matches_a0: `True`
- n3_a1_expected_status_counts: `{'stock': 1668, 'index': 7, 'board': 0}`
- n3_a1_actual_status_counts: `{'stock': 1668, 'index': 7, 'board': 0}`
- n3_a1_minute_rows_reasonable: `True`
- n3_a1_total_minute_rows_present: `True`
- n3_a1_expected_minute_rows_by_asset: `{'stock': 400320, 'index': 1680, 'board': 0}`
- n3_a1_actual_minute_rows_by_asset: `{'stock': 400320, 'index': 1680, 'board': 0}`
...
- n3_a1_object_status_counts: `{'passed': 1675}`
...
- n3_a1_global_event_counts_before: `{'common_event_outbox': 187526, 'common_event_inbox': 89757, 'common_event_consumer_checkpoint': 5169}`
- n3_a1_global_event_counts_after: `{'common_event_outbox': 187526, 'common_event_inbox': 89757, 'common_event_consumer_checkpoint': 5169}`
