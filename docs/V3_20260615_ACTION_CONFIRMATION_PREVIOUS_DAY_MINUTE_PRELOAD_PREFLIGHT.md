...
```bash
PYTHONPATH=src:scripts python3 scripts/run_previous_day_minute_preload_execute.py --contract-path docs/V3_20260615_ACTION_CONFIRMATION_PREVIOUS_DAY_MINUTE_PRELOAD_CONTRACT.json --historical-preload --source-subscription-run-id market_data_subscription_20260615_action_confirmation_previous_day_1005_scope__n4_production_semantic_replay_20260615_market_snapshot_updated_until_1000_v1 --preload-run-id previous_day_minute_preload_20260612_for_20260615_action_confirmation_1005_scope__n4_production_semantic_replay_20260615_market_snapshot_updated_until_1000_v1 --data-trade-date 20260612 --execute --user-confirmed
```
