...
- expected_row_count: `58320`
- writes_outbox: `False`
- P0/P1/P2: `0/0/0`

## Expected Asset Counts

- stock: objects=`234` subscriptions=`234` expected_minute_rows=`56160`
- index: objects=`0` subscriptions=`0` expected_minute_rows=`0`
- board: objects=`9` subscriptions=`9` expected_minute_rows=`2160`
...
- board: adapter=`BoardMarketDataAdapter` source_pull_plan_id=`65` objects=`9` expected_rows=`2160`
- stock: adapter=`StockMarketDataAdapter` source_pull_plan_id=`69` objects=`234` expected_rows=`56160`
...
- rollback_sql_path: `sql/N3_A1_previous_day_minute_20260529_rollback.sql`
...
- P0 passed n3_a1_source_run_id_matches_n3_6: expected=market_data_subscription_20260529_condition_layer_20260528_source_20260528_v1 actual=market_data_subscription_20260529_condition_layer_20260528_source_20260528_v1
- P0 passed n3_a1_n3_6_source_p0_zero: expected=P0=0 passed=true actual=P0=0 passed=True
- P0 passed n3_a1_previous_day_minute_date_matches_prev_trade_date: expected=20260528 actual=20260528
- P0 passed n3_a1_preload_run_id_distinct: expected=distinct non-empty preload_run_id actual=previous_day_minute_preload_20260528_for_20260529__market_data_subscription_20260529_condition_layer_20260528_source_20260528_v1
- P0 passed n3_a1_asset_counts_match_n3_6: expected={'stock': 234, 'index': 0, 'board': 9} actual={'stock': 234, 'index': 0, 'board': 9}
...
Rollback SQL was generated at `sql/N3_A1_previous_day_minute_20260529_rollback.sql`. It deletes rows by `source_run_id` and `preload_run_id` and does not touch `common_event_outbox`.
