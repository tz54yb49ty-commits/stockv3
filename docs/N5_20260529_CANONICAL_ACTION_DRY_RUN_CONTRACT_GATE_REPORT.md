# N5-20260529-canonical-action-dry-run-contract-gate Action Consumer Run-Once Dry-Run Report

## Summary

- stage: N5-20260529-canonical-action-dry-run-contract-gate
- layer_role: N5_action
- consumer_name: n5_action_consumer_v1
- source_trigger_run_id: trigger_execute_20260529_condition_layer_20260528_source_20260528_v1
- action_run_id: action_consumer_canonical_dry_run_20260529_trigger_execute_20260529_condition_layer_20260528_source_20260528_v1
...
- configured: True
- passed: True
- allowed_source_run_ids: ['trigger_execute_20260529_condition_layer_20260528_source_20260528_v1']
- denied_source_run_ids: ['trigger_context_snapshot_20260525_condition_layer_20260522_to_20260525_20260524014029_execute', 'trigger_context_snapshot_20260525_condition_layer_20260522_to_20260525_20260525003855_execute', 'trigger_projection_matcher_execute_20260525_condition_layer_20260522_to_20260525102249', 'trigger_execute_20260528_condition_layer_20260527_source_20260527_v2']
- denied_observed_source_run_ids: []
- outside_allowlist_source_run_ids: []

## Baseline Check

- baseline_report_path: inline:N4_20260529_V2_canonical_trigger_execute_contract
...
- source_run_id: {'trigger_execute_20260529_condition_layer_20260528_source_20260528_v1': 17722}
...
- before_row_counts: {'common_event_outbox': {'exists': True, 'row_count': 122844, 'status': 'present'}, 'common_event_inbox': {'exists': True, 'row_count': 20726, 'status': 'present'}, 'common_event_consumer_checkpoint': {'exists': True, 'row_count': 4345, 'status': 'present'}, 'common_action_run': {'exists': True, 'row_count': 2, 'status': 'present'}, 'common_action_quality_item': {'exists': True, 'row_count': 4878, 'status': 'present'}, 'stock_action_fact': {'exists': True, 'row_count': 4501, 'status': 'present'}, 'index_action_fact': {'exists': True, 'row_count': 18, 'status': 'present'}, 'board_action_fact': {'exists': True, 'row_count': 254, 'status': 'present'}, 'common_action_event': {'exists': True, 'row_count': 4773, 'status': 'present'}, 'common_position_state': {'exists': True, 'row_count': 0, 'status': 'present'}, 'common_position_event': {'exists': True, 'row_count': 0, 'status': 'present'}}
