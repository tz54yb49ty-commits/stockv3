# N4 Worker Bounded Smoke Execute Report
...
- rollback_sql: `sql/N4_worker_bounded_smoke_20260608_unified_output_probe_rollback.sql`
...
`N4_WORKER_BOUNDED_SMOKE_POST_REVIEW_GATE`
