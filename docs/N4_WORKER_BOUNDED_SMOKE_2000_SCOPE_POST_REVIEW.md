# N4 Worker Bounded Smoke 2000 Scope Post Review
...
```text
inbox rows=2000
distinct dedup_key=2000
distinct event_id=2000
processed=2000
not_processed=0
```
...
selected N3 source events pending=2000/2000
selected N3 source events not pending=0
selected distinct event_id/dedup_key=2000/2000
...
This 2000-scope probe is consumption-only. It validates bounded N4 inbox/checkpoint behavior at larger scope; it does not fabricate semantic trigger events.
...
deletes only scoped 2000 scope smoke rows=true
...
The N4 worker 2000 scope bounded smoke can be marked complete.
