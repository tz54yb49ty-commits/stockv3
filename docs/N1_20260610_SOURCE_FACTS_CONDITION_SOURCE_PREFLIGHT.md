{
  ...
  "execute_command_template": "PYTHONPATH=src python3 scripts/run_condition_source_activation_20260605_once.py --execute --user-confirmed --postgres-commit-enabled --execute-report-json docs/N1_20260610_SOURCE_FACTS_EXECUTE_REPORT.json --execute-report-md docs/N1_20260610_SOURCE_FACTS_EXECUTE_REPORT.md",
  "side_effects": {
