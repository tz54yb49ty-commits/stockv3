# V3 Runtime Archive Closeout Registration
...
## Residual Notes
- first implementation performs synchronous full-table pandas export; future archive scheduler should use per-table streaming/batched export
- local hot DB cleanup remains manual-only and is not authorized by this closeout
- MacRaid cold archive must not be used by trading-time runtime paths
