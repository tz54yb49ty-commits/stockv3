...
```bash
PYTHONPATH=src:scripts python3 scripts/run_previous_day_minute_preload_execute.py --contract-path docs/N3_A1_previous_day_minute_20260605_b2_stock_index_lineage_expansion_execute_contract.json --execute --user-confirmed
```
