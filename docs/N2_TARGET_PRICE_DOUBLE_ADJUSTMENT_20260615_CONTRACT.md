# N2 Target Price Double Adjustment 20260615 Active Supersede Contract

status = CONTRACT_READY_FOR_USER_CONFIRMATION
...
```bash
PYTHONPATH=src python3 scripts/run_condition_layer_execute.py --source-trade-date 20260615 --policy configs/n2_policy/default_policy_draft.json --run-id condition_layer_20260615_source_20260615_for_20260616_v3 --execute --overwrite --user-confirmed --operator codex --confirmation-note N2-20260615-target-price-double-adjustment-v3-active-supersede --report-path docs/N2_TARGET_PRICE_DOUBLE_ADJUSTMENT_20260615_V3_ACTIVE_SUPERSEDE_EXECUTE_REPORT.json
```
