...
- P0/P1/P2: `0/0/0`
- fact_only_label_policy: `index/board untrusted period labels normalize_to_observed_at; standard outbox does not inherit`
...
- board: adapter=`BoardMarketDataAdapter` source_pull_plan_id=`228` objects=`127` expected_rows=`127`
- index: adapter=`IndexMarketDataAdapter` source_pull_plan_id=`231` objects=`83` expected_rows=`83`
- stock: adapter=`StockMarketDataAdapter` source_pull_plan_id=`234` objects=`1822` expected_rows=`1822`
...
- rollback_sql_path: `sql/N3_B1_realtime_snapshot_20260616_until_1401_v4_lineage_rollback.sql`
...
- P0 passed n3_b1_source_run_id_matches_n3_6: expected=market_data_subscription_20260616_condition_layer_20260615_source_20260615_for_20260616_v4 actual=market_data_subscription_20260616_condition_layer_20260615_source_20260615_for_20260616_v4
- P0 passed n3_b1_n3_6_source_p0_zero: expected=P0=0 passed=true actual=P0=0 passed=True
- P0 passed n3_b1_snapshot_run_id_distinct: expected=distinct non-empty snapshot_run_id actual=realtime_daily_snapshot_20260616_until_1401__market_data_subscription_20260616_condition_layer_20260615_source_20260615_for_20260616_v4
...
Rollback SQL was generated at `sql/N3_B1_realtime_snapshot_20260616_until_1401_v4_lineage_rollback.sql`. It deletes rows by `source_run_id`, `snapshot_run_id`, and `for_trade_date`; it includes scoped outbox/inbox/checkpoint prechecks and does not modify downstream tables.
