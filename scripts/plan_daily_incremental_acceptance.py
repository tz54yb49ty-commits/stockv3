#!/usr/bin/env python3
"""Print a daily incremental raw-ingestion acceptance checklist dry-run."""
...
def main() -> int:
    ...
    summary = build_daily_incremental_execution_checklist(plan, source_configs=config.sources)
    checklist = build_daily_incremental_acceptance_checklist(summary)
