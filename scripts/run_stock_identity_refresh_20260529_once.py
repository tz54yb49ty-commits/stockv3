#!/usr/bin/env python3
"""Run N1 stock_identity 20260529 refresh preflight or final execute."""
...
from ashare_v3.ingestion.stock_identity_refresh_20260529_execute import (  # noqa: E402
    DEFAULT_PATHS,
    EXPECTED_TS_CODE,
    TRADE_DATE,
    DefaultStockIdentityRefresh20260529SourceAdapter,
...
def build_default_source_adapter(**kwargs) -> DefaultStockIdentityRefresh20260529SourceAdapter:
    return DefaultStockIdentityRefresh20260529SourceAdapter(token=load_tushare_token())
...
def main(argv: list[str] | None = None, *, dependencies: dict | None = None) -> int:
    ...
    if args.execute:
        ...
        except StockIdentityRefresh20260529Blocked as exc:
    ...
    try:
        if evidence is None:
            raise StockIdentityRefresh20260529Blocked("source evidence was not loaded")
    ...
    print(
        json.dumps(
            {
                "stage": "N1 stock_identity refresh 20260529 execute",
