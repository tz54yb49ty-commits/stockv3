#!/usr/bin/env python3
"""Print the N3.9 environment probe execution application dry-run package."""
...
from ashare_v3.ingestion.environment_probe_application import build_environment_probe_application_package
...
def main() -> int:
    ...
    print(json.dumps(package.to_dict(), ensure_ascii=False, indent=2, sort_keys=True))
    return 0
