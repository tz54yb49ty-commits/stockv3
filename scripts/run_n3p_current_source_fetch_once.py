#!/usr/bin/env python3
"""Contract wrapper for one N3P current source fetch child step."""
...
LAYER_RUNNER_NAME = "n3p_current_source_fetch_real_runner"
...
def main(
    ...
    *,
    ...
    return run_child_contract(
        ...
        description="Plan one N3P current source fetch child step.",
        layer_runner=resolved_runner,
        layer_runner_name=LAYER_RUNNER_NAME,
        audited_layer_capability="n3p_mixed_realtime_current_source_payload",
        target_absence_checker=target_absence_checker,
        output_contract={
            "writes_outbox": False,
            "writes_n3p_metric_rows": False,
            "source_payload_run_required": True,
        },
    )
