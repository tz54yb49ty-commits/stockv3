#!/usr/bin/env python3
"""Print a raw-ingestion acceptance checklist dry-run."""
...
def main() -> int:
    ...
    summary = build_backfill_execution_checklist(plan)
    checklist = build_ingestion_acceptance_checklist(summary)
