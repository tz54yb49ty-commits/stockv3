#!/usr/bin/env python3
"""Run N1 condition source activation 20260527 preflight or final execute."""
...
from ashare_v3.ingestion.condition_source_activation_20260527_execute import (  # noqa: E402
    DEFAULT_PATHS,
    TDX_ROOT,
    TRADE_DATE,
    ConditionSourceActivation20260527Blocked,
    DefaultConditionSourceActivation20260527SourceBuilder,
    build_commit_plan,
...
def build_default_source_builder(**kwargs) -> DefaultConditionSourceActivation20260527SourceBuilder:
    args = kwargs.get("args")
    return DefaultConditionSourceActivation20260527SourceBuilder(
...
def main(argv: list[str] | None = None, *, dependencies: dict | None = None) -> int:
    ...
    if args.execute:
        ...
        except ConditionSourceActivation20260527Blocked as exc:
    ...
    print(
        json.dumps(
            {
                "stage": "N1 condition source activation 20260527 execute",
