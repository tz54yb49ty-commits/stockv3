#!/usr/bin/env python3
"""Run N1 official daily 20260529 ingestion dry-run, preflight, or final execute.
...
from ashare_v3.ingestion.official_daily_20260529_execute import (  # noqa: E402
    DEFAULT_PATHS,
    TRADE_DATE,
    DefaultOfficialDaily20260529SourceAdapter,
...
def build_default_source_adapter(**kwargs) -> DefaultOfficialDaily20260529SourceAdapter:
    args = kwargs.get("args")
    return DefaultOfficialDaily20260529SourceAdapter(
...
def main(argv: list[str] | None = None, *, dependencies: dict | None = None) -> int:
    ...
    if args.execute:
        ...
        except OfficialDaily20260529ExecuteBlocked as exc:
    ...
    print(
        json.dumps(
            {
                "stage": "N1 official daily 20260529 ingestion execute",
