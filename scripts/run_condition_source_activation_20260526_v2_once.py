#!/usr/bin/env python3
"""Run N1 condition source activation 20260526 v2 preflight or final execute.

The execute path is wired but guarded by explicit flags. Without all flags this
script refreshes v2 preflight/contract artifacts and exits before source row
build or PostgreSQL commit.
"""
...
from ashare_v3.ingestion.condition_source_activation_20260526_v2_execute import (  # noqa: E402
    DEFAULT_PATHS,
    TDX_ROOT,
    TRADE_DATE,
    ConditionSourceActivation20260526V2Blocked,
    DefaultConditionSourceActivation20260526V2SourceBuilder,
    build_commit_plan,
...
def build_default_source_builder(**kwargs) -> DefaultConditionSourceActivation20260526V2SourceBuilder:
    args = kwargs.get("args")
    return DefaultConditionSourceActivation20260526V2SourceBuilder(
...
def main(argv: list[str] | None = None, *, dependencies: dict | None = None) -> int:
    ...
    print(
        json.dumps(
            {
                "stage": "N1 condition source activation 20260526 v2 execute",
