#!/usr/bin/env python3
"""Print the environment probe result report template dry-run."""
...
from ashare_v3.ingestion.environment_probe_result import build_environment_probe_result_template
...
def main() -> int:
    ...
    report = build_environment_probe_result_template(
