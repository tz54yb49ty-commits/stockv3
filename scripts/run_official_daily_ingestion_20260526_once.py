#!/usr/bin/env python3
"""Run N1 official daily 20260526 ingestion preflight or final execute.
...
from ashare_v3.ingestion.official_daily_20260526_execute import (  # noqa: E402
...
def build_default_source_adapter(**kwargs) -> DefaultOfficialDaily20260526SourceAdapter:
    args = kwargs.get("args")
    return DefaultOfficialDaily20260526SourceAdapter(
...
def main(argv: list[str] | None = None, *, dependencies: dict | None = None) -> int:
    ...
    if args.execute:
        ...
        except OfficialDaily20260526ExecuteBlocked as exc:
    ...
    print(
        json.dumps(
            {
                "stage": "N1 official daily 20260526 ingestion execute",
