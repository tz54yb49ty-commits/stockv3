#!/usr/bin/env python3
"""Run the guarded N1 official daily 20260605 dry-run/preflight/execute gate."""
...
from ashare_v3.ingestion.official_daily_20260605_execute import (  # noqa: E402
    DEFAULT_PATHS,
    TRADE_DATE,
    DefaultOfficialDaily20260605SourceAdapter,
...
def build_default_source_adapter(**kwargs) -> DefaultOfficialDaily20260605SourceAdapter:
    args = kwargs.get("args")
    return DefaultOfficialDaily20260605SourceAdapter(
...
def main(argv: list[str] | None = None, *, dependencies: dict | None = None) -> int:
    ...
    if args.execute:
        ...
        except OfficialDaily20260605ExecuteBlocked as exc:
    ...
    print(
        json.dumps(
            {
                "stage": "N1 official daily 20260605 ingestion execute",
