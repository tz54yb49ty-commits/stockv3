#!/usr/bin/env python3
"""Run N1 official daily 20260527 ingestion preflight or final execute.

The execute path is wired, but guarded by three explicit flags. Without all
...
from ashare_v3.ingestion.official_daily_20260527_execute import (  # noqa: E402
    DEFAULT_PATHS,
    TRADE_DATE,
    DefaultOfficialDaily20260527SourceAdapter,
...
def build_default_source_adapter(**kwargs) -> DefaultOfficialDaily20260527SourceAdapter:
    args = kwargs.get("args")
    return DefaultOfficialDaily20260527SourceAdapter(
...
def main(argv: list[str] | None = None, *, dependencies: dict | None = None) -> int:
    ...
    if args.execute:
        ...
        except OfficialDaily20260527ExecuteBlocked as exc:
    ...
    print(
        json.dumps(
            {
                "stage": "N1 official daily 20260527 ingestion execute",
