#!/usr/bin/env python3
"""N1 20260529 trade-calendar patch runner.
...
from ashare_v3.ingestion.trade_calendar_patch_20260529 import (  # noqa: E402
    DEFAULT_DSN,
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.trade_date != TRADE_DATE:
        print(f"BLOCKED: this run-once runner is scoped to --trade-date {TRADE_DATE}", file=sys.stderr)
        return 2
    ...
    except CalendarPatch20260529Blocked as exc:
