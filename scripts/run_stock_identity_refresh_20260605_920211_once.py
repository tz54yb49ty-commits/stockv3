#!/usr/bin/env python3
"""Run N1 stock_identity 920211.BJ 20260605 refresh preflight or final execute."""
...
from ashare_v3.ingestion.stock_identity_refresh_20260605_920211_execute import (  # noqa: E402
    DEFAULT_PATHS,
    EXPECTED_TS_CODE,
    TRADE_DATE,
    DefaultStockIdentityRefresh20260605920211SourceAdapter,
...
def build_default_source_adapter(**kwargs) -> DefaultStockIdentityRefresh20260605920211SourceAdapter:
    return DefaultStockIdentityRefresh20260605920211SourceAdapter(token=load_tushare_token())
...
def main(argv: list[str] | None = None, *, dependencies: dict | None = None) -> int:
    ...
    if args.execute:
        ...
        except StockIdentityRefresh20260605920211Blocked as exc:
    ...
    try:
        ...
        evidence = adapter.fetch_source_evidence(trade_date=args.trade_date, ts_code=EXPECTED_TS_CODE)
    ...
    try:
        if evidence is None:
            raise StockIdentityRefresh20260605920211Blocked("source evidence was not loaded")
    ...
    print(
        json.dumps(
            {
                "stage": "N1 stock_identity 920211 20260605 refresh execute",
