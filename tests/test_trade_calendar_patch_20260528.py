...
from ashare_v3.ingestion.trade_calendar_patch_20260528 import (
    ALLOWED_WRITE_TABLES,
    CalendarPatch20260528Blocked,
...
class TradeCalendarPatch20260528Tests(unittest.TestCase):
    def test_tushare_source_builds_passed_patch_plan(self) -> None:
        ...
        self.assertEqual("trade_calendar_20260528_patch_v1", report["patch"]["source_batch_id"])
        self.assertEqual("SSE:20260528", report["scope_key"])
        self.assertEqual("20260527", report["patch"]["calendar_row"]["prev_trade_date"])
        self.assertEqual("20260529", report["patch"]["calendar_row"]["next_trade_date"])
    ...
    def test_previous_calendar_next_trade_date_guard_blocks_mismatch(self) -> None:
        snapshot = baseline_snapshot()
        snapshot["calendar_window"][0]["next_trade_date"] = "20260529"
    ...
    def test_fallback_requires_flag_and_records_p2_warning(self) -> None:
        ...
        self.assertEqual("20260527", fallback["patch"]["calendar_row"]["prev_trade_date"])
    ...
    def test_execute_requires_all_flags(self) -> None:
        with self.assertRaises(CalendarPatch20260528Blocked):
            validate_execute_request(
