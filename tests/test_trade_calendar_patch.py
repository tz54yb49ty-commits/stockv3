...
from ashare_v3.ingestion.trade_calendar_patch import (
        ...
        "calendar_window": [
            {
                ...
                "source_version": "trade_calendar_20260525_min_patch_v1",
                "source_batch_id": "trade_calendar_20260525_min_patch_v1",
            }
        ],
...
class TradeCalendarPatchTests(unittest.TestCase):
    def test_tushare_source_builds_passed_patch_plan(self) -> None:
        ...
        self.assertEqual("trade_calendar_20260526_patch_v1", report["patch"]["source_batch_id"])
        self.assertEqual("20260525", report["patch"]["calendar_row"]["prev_trade_date"])
        self.assertEqual("20260527", report["patch"]["calendar_row"]["next_trade_date"])
    ...
    def test_execute_requires_all_flags(self) -> None:
        with self.assertRaises(CalendarPatchBlocked):
            validate_execute_request(
