-- Rollback draft for N2 web policy execute gate.
-- Do not execute without explicit user confirmation.
--
-- Scope:
--   Delete only condition_layer_20260528_source_20260528_v6 rows.
--   Restore condition_layer_20260528_source_20260528_v5 to passed_active.
--
-- Boundary:
...
--   Blocks if condition_layer_20260528_source_20260528_v6 already has event infra or downstream N3/N4/N5/N6 refs.

BEGIN;

DO $$
DECLARE
  rollback_run_id text := 'condition_layer_20260528_source_20260528_v6';
  restore_run_id text := 'condition_layer_20260528_source_20260528_v5';
  event_refs bigint := 0;
...
DELETE FROM stock_condition_display_basis WHERE run_id = 'condition_layer_20260528_source_20260528_v6';
DELETE FROM index_condition_display_basis WHERE run_id = 'condition_layer_20260528_source_20260528_v6';
DELETE FROM board_condition_display_basis WHERE run_id = 'condition_layer_20260528_source_20260528_v6';

DELETE FROM stock_minute_target_scope WHERE run_id = 'condition_layer_20260528_source_20260528_v6';
DELETE FROM index_minute_target_scope WHERE run_id = 'condition_layer_20260528_source_20260528_v6';
DELETE FROM board_minute_target_scope WHERE run_id = 'condition_layer_20260528_source_20260528_v6';

DELETE FROM stock_condition_pool WHERE run_id = 'condition_layer_20260528_source_20260528_v6';
DELETE FROM index_condition_pool WHERE run_id = 'condition_layer_20260528_source_20260528_v6';
DELETE FROM board_condition_pool WHERE run_id = 'condition_layer_20260528_source_20260528_v6';

DELETE FROM stock_condition_basis WHERE run_id = 'condition_layer_20260528_source_20260528_v6';
DELETE FROM index_condition_basis WHERE run_id = 'condition_layer_20260528_source_20260528_v6';
DELETE FROM board_condition_basis WHERE run_id = 'condition_layer_20260528_source_20260528_v6';

DELETE FROM stock_monitor_target WHERE source_version = 'condition_layer_20260528_source_20260528_v6';
DELETE FROM index_monitor_target WHERE source_version = 'condition_layer_20260528_source_20260528_v6';
DELETE FROM board_monitor_target WHERE source_version = 'condition_layer_20260528_source_20260528_v6';

DELETE FROM common_condition_quality_item WHERE run_id = 'condition_layer_20260528_source_20260528_v6';
DELETE FROM common_condition_run WHERE run_id = 'condition_layer_20260528_source_20260528_v6';

UPDATE common_condition_run
SET status = 'passed_active', updated_at = now()
WHERE run_id = 'condition_layer_20260528_source_20260528_v5'
