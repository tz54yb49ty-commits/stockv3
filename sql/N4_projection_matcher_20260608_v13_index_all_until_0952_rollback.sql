...
DO $$
BEGIN
  RAISE EXCEPTION 'N4 projection matcher rollback is guarded. Review delivered outbox, inbox/checkpoint, N5/N6, notification, sim, position, and trade refs before enabling scoped deletes for trigger_projection_matcher_execute_20260608_v13_index_all_until_0952.';
END $$;
...
WHERE source_layer = 'N4_trigger'
  AND source_run_id = 'trigger_projection_matcher_execute_20260608_v13_index_all_until_0952'
...
WHERE run_id = 'trigger_projection_matcher_execute_20260608_v13_index_all_until_0952';
...
WHERE consumer_name = 'n4_projection_matcher_consumer_v1'
  AND raw_json ->> 'execute_run_id' = 'trigger_projection_matcher_execute_20260608_v13_index_all_until_0952';

DELETE FROM common_event_consumer_checkpoint
WHERE consumer_name = 'n4_projection_matcher_consumer_v1'
  AND source_layer = 'N3_market_data'
  AND checkpoint_payload ->> 'execute_run_id' = 'trigger_projection_matcher_execute_20260608_v13_index_all_until_0952';
