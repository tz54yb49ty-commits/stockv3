-- N1 trade calendar 20260608 patch rollback draft.
-- Scope: trade_calendar_20260608_patch_v1.
-- This rollback does not touch 20260605 source facts, N2/N3/N4/N5/N6 facts,
...
DO $$
DECLARE
  v_batch_id text := 'trade_calendar_20260608_patch_v1';
  v_source_version text := 'trade_calendar_20260608_patch_v1';
  v_scope_key text := 'SSE:20260608';
...
BEGIN
  ...
  IF v_outbox_refs <> 0
     ...
     OR v_n6_refs <> 0 THEN
    RAISE EXCEPTION
      'Refusing 20260608 calendar rollback: outbox %, inbox %, checkpoint %, N2 %, N3 %, N4 %, N5 %, N6 %',
...
WHERE data_domain = 'common'
  ...
  AND scope_key = 'SSE:20260608'
  AND source_batch_id = 'trade_calendar_20260608_patch_v1'
  AND source_version = 'trade_calendar_20260608_patch_v1';
...
WHERE source_batch_id = 'trade_calendar_20260608_patch_v1'
   OR source_version = 'trade_calendar_20260608_patch_v1';

DELETE FROM common_ingest_batch
WHERE batch_id = 'trade_calendar_20260608_patch_v1'
   OR source_version = 'trade_calendar_20260608_patch_v1';
