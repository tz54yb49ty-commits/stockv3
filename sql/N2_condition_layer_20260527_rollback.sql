-- N2 condition layer 20260527 rollback draft.
-- Suggested run_id: condition_layer_20260527_source_20260527_v1
-- Usage:
--   psql "$ASHARE_V3_POSTGRES_DSN" -v ON_ERROR_STOP=1 -v run_id='ACTUAL_N2_RUN_ID' -f sql/N2_condition_layer_20260527_rollback.sql
