-- N2 -> N6 buy_expected_return_pct display-basis pass-through migration.
...
-- Do not execute without explicit schema execute gate approval.

BEGIN;

ALTER TABLE stock_condition_display_basis
  ADD COLUMN IF NOT EXISTS buy_expected_return_pct NUMERIC;
ALTER TABLE index_condition_display_basis
  ADD COLUMN IF NOT EXISTS buy_expected_return_pct NUMERIC;
ALTER TABLE board_condition_display_basis
  ADD COLUMN IF NOT EXISTS buy_expected_return_pct NUMERIC;

UPDATE stock_condition_display_basis AS display
SET buy_expected_return_pct = basis.buy_expected_return_pct
FROM stock_condition_basis AS basis
WHERE display.primary_source_condition_basis_id = basis.stock_condition_basis_id
  AND display.buy_expected_return_pct IS DISTINCT FROM basis.buy_expected_return_pct;

UPDATE index_condition_display_basis AS display
SET buy_expected_return_pct = basis.buy_expected_return_pct
FROM index_condition_basis AS basis
WHERE display.primary_source_condition_basis_id = basis.index_condition_basis_id
  AND display.buy_expected_return_pct IS DISTINCT FROM basis.buy_expected_return_pct;

UPDATE board_condition_display_basis AS display
SET buy_expected_return_pct = basis.buy_expected_return_pct
FROM board_condition_basis AS basis
WHERE display.primary_source_condition_basis_id = basis.board_condition_basis_id
  AND display.buy_expected_return_pct IS DISTINCT FROM basis.buy_expected_return_pct;
