-- Rollback for stock_financial canonical metrics 20260724 v2 execute.
-- Generated and verified before database commit. Execute only under a separate authorized rollback gate.
-- Scope: only stock_financial_canonical_20260724_v1 / stock_financial_20260724_v2.
...
BEGIN
  ...
  WHERE data_domain = 'stock'
    ...
    AND scope_key = '20260724'
    AND source_version = 'stock_financial_20260724_v2'
    AND source_batch_id = 'stock_financial_canonical_20260724_v1';
  ...
  WHERE source_batch_id = 'stock_financial_canonical_20260724_v1'
    AND source_version = 'stock_financial_20260724_v2'
  ...
  WHERE batch_id = 'stock_financial_canonical_20260724_v1'
    AND trade_date = '20260724'
    AND source_version = 'stock_financial_20260724_v2'
    AND data_domain = 'stock'
    AND data_type = 'stock_financial_canonical_metrics'
    AND status = 'passed'
  ...
  IF v_active_count <> 1
     OR v_target_row_count <> 5508
     OR v_target_identity_count <> 5508
     OR v_previous_row_count <> 5508
     OR v_previous_identity_count <> 5508
  ...
  SET source_version = 'stock_financial_20260724_v1',
      previous_source_version = NULL,
      source_batch_id = 'condition_source_activation_20260724_v1',
      activated_at = now(),
      activated_by = 'rollback.stock_financial_20260724_v2'
  WHERE data_domain = 'stock'
    AND data_type = 'stock_financial'
    AND scope_key = '20260724'
    AND source_version = 'stock_financial_20260724_v2'
