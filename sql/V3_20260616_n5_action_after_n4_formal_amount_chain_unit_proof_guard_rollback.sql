-- N5 action replay rollback after N4 formal amount-chain unit proof guard.
...
\set action_run_id 'v3_n5_action_replay_20260616_after_n4_formal_amount_chain_unit_proof_guard_v1'
\set source_trigger_run_id 'v3_n4_trigger_replay_20260616_until_1401_v1'
\set consumer_name 'n5_action_consumer_v1_20260616_formal_amount_chain_unit_proof_guard_replay'
...
BEGIN
  ...
  -- Non-scoped consumer checkpoints on preserved N4 source partitions are not
  -- downstream refs to this N5 action run. They must remain untouched, but they
  -- must not block rollback of this dedicated N5 consumer's inbox/checkpoint rows.
