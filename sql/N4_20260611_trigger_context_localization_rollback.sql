...
-- This rollback removes only N4 trigger context/run/quality rows for one run_id.
...
DO $$
BEGIN
  RAISE EXCEPTION 'N4 20260611 trigger context localization rollback is hard-failed by default. Remove this line only in an approved rollback execute gate for run_id=trigger_context_snapshot_20260611_condition_layer_20260610_source_20260610_for_20260611_v1 after downstream refs are rechecked.';
END $$;
...
DELETE FROM common_trigger_quality_item WHERE run_id = 'trigger_context_snapshot_20260611_condition_layer_20260610_source_20260610_for_20260611_v1';
DELETE FROM stock_trigger_context_snapshot WHERE run_id = 'trigger_context_snapshot_20260611_condition_layer_20260610_source_20260610_for_20260611_v1';
DELETE FROM index_trigger_context_snapshot WHERE run_id = 'trigger_context_snapshot_20260611_condition_layer_20260610_source_20260610_for_20260611_v1';
DELETE FROM board_trigger_context_snapshot WHERE run_id = 'trigger_context_snapshot_20260611_condition_layer_20260610_source_20260610_for_20260611_v1';
DELETE FROM common_trigger_run WHERE run_id = 'trigger_context_snapshot_20260611_condition_layer_20260610_source_20260610_for_20260611_v1';
