...
-- Restore the exact published 055/059 function bodies.
-- This is fail-closed and never deletes AI or virtual-account history.
...
BEGIN
  ...
  IF source_count = 5 THEN
    RAISE EXCEPTION '060_already_applied: rollback already restored source';
  END IF;
  IF fixed_count <> 5 OR source_count <> 0 THEN
...
BEGIN
  FOR expected IN
    ...
    FROM (
      VALUES
      ('n6_ai_agent_daily_summary_record(jsonb)', 'c8e0928d3afb20535792a82b20270d32d66d466a85d0d112aefc64fa8f573a5e'),
      ('n6_ai_agent_context_load(text,date,integer)', 'bbcd60822e8d18e6731ac0f46e68d2dd545dea08a172f28655eead4e1444fa84'),
      ('n6_ai_agent_proposal_create_confirm(jsonb)', '2bde0f7d24cd88bc2851fb162b8499730560e8959c8f814d6625a97fe9db063b'),
      ('n6_ai_executor_risk_recheck(bigint,text)', '51faf7163dd35ead8f290c7a0ec17849f56dd0906339b8de4b7f1c5c932e834c'),
      ('n6_ai_strategy_shadow_evaluate(date,text,text)', 'a7cd3200d0c4a226c9ea03fc14e62a03f86877f768d991911eafc8b7a13c2cb2')
