...
-- Hard-fail before row removal when scoped event infra, C2/projection, N4/N5/N6, downstream, or worker refs exist.
...
DELETE FROM common_market_data_quality_item WHERE run_id = 'today_minute_bar_1m_20260608_until_1500_action_metric_coverage_repair_v1__market_data_subscription_20260608_action_metric_coverage_repair_v1';
DELETE FROM stock_minute_bar_1m WHERE run_id = 'today_minute_bar_1m_20260608_until_1500_action_metric_coverage_repair_v1__market_data_subscription_20260608_action_metric_coverage_repair_v1' AND is_previous_day_preload = false;
DELETE FROM index_minute_bar_1m WHERE run_id = 'today_minute_bar_1m_20260608_until_1500_action_metric_coverage_repair_v1__market_data_subscription_20260608_action_metric_coverage_repair_v1' AND is_previous_day_preload = false;
DELETE FROM board_minute_bar_1m WHERE run_id = 'today_minute_bar_1m_20260608_until_1500_action_metric_coverage_repair_v1__market_data_subscription_20260608_action_metric_coverage_repair_v1' AND is_previous_day_preload = false;
DELETE FROM common_market_data_run WHERE run_id = 'today_minute_bar_1m_20260608_until_1500_action_metric_coverage_repair_v1__market_data_subscription_20260608_action_metric_coverage_repair_v1' AND downstream_layers_touched = false AND worker_started = false;
