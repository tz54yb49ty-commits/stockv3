...
\set source_run_id 'market_data_subscription_20260605_condition_layer_20260604_source_20260604_v1'
\set snapshot_run_id 'realtime_snapshot_20260605_market_data_subscription_20260605_condition_layer_20260604_source_20260604_v1'
\set for_trade_date '20260605'
...
BEGIN
  ...
  IF scoped_outbox_refs_must_be_zero <> 0
    ...
    RAISE EXCEPTION
      'N3-B1 rollback blocked for %, outbox=%, delivered_or_delivering=%, inbox=%, checkpoint=%, trigger=%, action=%, n6=%, downstream_touched=%, worker=%',
      target_snapshot_run_id, scoped_outbox_refs_must_be_zero, delivered_or_delivering_outbox_rows_must_be_zero,
      downstream_inbox_rows_must_be_zero, checkpoint_refs_must_be_zero, trigger_refs, action_refs, n6_refs,
      downstream_touched_refs, worker_started_refs;
  END IF;
END $$;
