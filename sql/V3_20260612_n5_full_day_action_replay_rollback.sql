-- V3 20260612 N5 full-day action replay rollback.
-- Scoped to run_id=v3_n5_action_replay_20260612_after_n4_full_day_trigger_v1
-- and consumer_name=v3_n5_action_replay_20260612_full_day_consumer_v1.
...
DO $$
DECLARE
  target_run_id text := 'v3_n5_action_replay_20260612_after_n4_full_day_trigger_v1';
  source_trigger_run_id text := 'v3_n4_trigger_replay_20260612_after_n3_full_day_metric_v1';
  target_consumer_name text := 'v3_n5_action_replay_20260612_full_day_consumer_v1';
  v_count bigint;
BEGIN
  IF current_setting('ashare_v3.allow_v3_20260612_n5_full_day_action_replay_rollback', true) <> 'true' THEN
    RAISE EXCEPTION 'hard-fail: set ashare_v3.allow_v3_20260612_n5_full_day_action_replay_rollback=true before DELETE';
  END IF;
...
WHERE consumer_name = 'v3_n5_action_replay_20260612_full_day_consumer_v1'
  AND source_layer = 'N4_trigger';

DELETE FROM common_event_inbox
WHERE consumer_name = 'v3_n5_action_replay_20260612_full_day_consumer_v1'
  AND source_run_id = 'v3_n4_trigger_replay_20260612_after_n3_full_day_metric_v1';

DELETE FROM common_event_outbox
WHERE source_run_id = 'v3_n5_action_replay_20260612_after_n4_full_day_trigger_v1';

DELETE FROM common_action_event
WHERE run_id = 'v3_n5_action_replay_20260612_after_n4_full_day_trigger_v1';
