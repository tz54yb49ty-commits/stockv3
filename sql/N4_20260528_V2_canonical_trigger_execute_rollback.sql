-- N4 20260528 v2 canonical trigger execute rollback.
-- Scope: execute_run_id=trigger_execute_20260528_condition_layer_20260527_source_20260527_v2
...
DO $$
DECLARE
  v_run_id TEXT := 'trigger_execute_20260528_condition_layer_20260527_source_20260527_v2';
  v_count BIGINT;
BEGIN
...
WHERE source_layer = 'N4_trigger'
  AND source_run_id = 'trigger_execute_20260528_condition_layer_20260527_source_20260527_v2';

DELETE FROM common_trigger_match
WHERE run_id = 'trigger_execute_20260528_condition_layer_20260527_source_20260527_v2';
