...
\set source_run_id 'market_data_subscription_20260616_condition_layer_20260615_source_20260615_for_20260616_v1'
\set snapshot_run_id 'realtime_daily_snapshot_20260616_until_1401__market_data_subscription_20260616_condition_layer_20260615_source_20260615_for_20260616_v1'
\set for_trade_date '20260616'
\set source_condition_run_id 'condition_layer_20260615_source_20260615_for_20260616_v1'

SELECT set_config('app.snapshot_run_id', :'snapshot_run_id', false);

DO $$
BEGIN
  IF current_setting('ashare_v3.allow_n3_b1_20260616_until_1401_rollback', true) <> 'true' THEN
    RAISE EXCEPTION 'N3-B1 20260616 until_1401 rollback hard-fail: set ashare_v3.allow_n3_b1_20260616_until_1401_rollback=true after final gate review';
  END IF;
END $$;
