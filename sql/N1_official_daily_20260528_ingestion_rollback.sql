-- N1 official daily 20260528 rollback draft.
-- Scope: official_daily_ingest_20260528_v1.
-- This rollback only clears the 20260528 official daily v1 batch/version rows.
...
WHERE scope_key = '20260528'
  AND source_batch_id = 'official_daily_ingest_20260528_v1'
...
WHERE trade_date = '20260528'
  AND source_batch_id = 'official_daily_ingest_20260528_v1'
  AND source_version = 'stock_daily_20260528_v1';

DELETE FROM index_daily_bar_fact
WHERE trade_date = '20260528'
  AND source_batch_id = 'official_daily_ingest_20260528_v1'
  AND source_version = 'index_daily_20260528_v1';

DELETE FROM board_daily_bar_fact
WHERE trade_date = '20260528'
  AND source_batch_id = 'official_daily_ingest_20260528_v1'
  AND source_version = 'board_daily_20260528_v1';

DELETE FROM common_quality_gate_result
WHERE source_batch_id = 'official_daily_ingest_20260528_v1'
...
WHERE batch_id = 'official_daily_ingest_20260528_v1'
   OR source_version IN (
