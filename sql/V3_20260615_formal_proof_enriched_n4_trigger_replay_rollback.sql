...
-- Scope: execute_run_id=v3_n4_trigger_replay_20260615_after_formal_proof_enrichment_v1
...
DO $$
DECLARE
  v_run_id TEXT := 'v3_n4_trigger_replay_20260615_after_formal_proof_enrichment_v1';
  v_count BIGINT;
  v_table TEXT;
BEGIN
...
WHERE source_layer = 'N4_trigger'
  AND source_run_id = 'v3_n4_trigger_replay_20260615_after_formal_proof_enrichment_v1';

DELETE FROM common_trigger_match
WHERE run_id = 'v3_n4_trigger_replay_20260615_after_formal_proof_enrichment_v1';
