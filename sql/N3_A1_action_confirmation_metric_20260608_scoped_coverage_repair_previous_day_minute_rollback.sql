...
-- Scope: N3 previous-day minute preload rows only. It intentionally does not write or remove event infrastructure.

\set ON_ERROR_STOP on
\set source_run_id 'market_data_subscription_20260608_action_metric_coverage_repair_v1__trigger_projection_matcher_execute_20260608_v13_index_all_until_1500_formal_snapshot_fallback_retry'
\set preload_run_id 'previous_day_minute_preload_20260605_for_20260608_action_metric_coverage_repair_v1__market_data_subscription_20260608_action_metric_coverage_repair_v1'
\set previous_day_minute_date '20260605'
\set source_condition_run_id 'condition_layer_20260605_to_20260608_v13_index_all_execute'

BEGIN;

DO $$
DECLARE
  v_preload_run_id TEXT := 'previous_day_minute_preload_20260605_for_20260608_action_metric_coverage_repair_v1__market_data_subscription_20260608_action_metric_coverage_repair_v1';
  v_count BIGINT;
  v_table TEXT;
BEGIN
