-- N2 20260529 symmetry secondary-anchor v5 active-supersede rollback.
-- Scope: remove only condition_layer_20260529_source_20260529_v5 rows and
-- restore condition_layer_20260529_source_20260529_v4 to passed_active.
--
-- Boundary:
-- - Does not touch v4/v3/v2/v1 rows except restoring v4 common_condition_run.status.
-- - Does not touch N1 source_version.
-- - Does not touch common_event_outbox / common_event_inbox / common_event_consumer_checkpoint.
-- - Blocks rollback if v5 has already been consumed by N3/N4/N5/N6 downstream refs.
--
-- Usage:
--   psql "$ASHARE_V3_POSTGRES_DSN" -v ON_ERROR_STOP=1 \
--     -f sql/N2_symmetry_secondary_anchor_20260529_v5_rollback.sql

BEGIN;

CREATE TEMP TABLE _n2_v5_downstream_ref_guard (
  table_name TEXT NOT NULL,
  column_name TEXT NOT NULL
) ON COMMIT DROP;

INSERT INTO _n2_v5_downstream_ref_guard(table_name, column_name) VALUES
...
DO $$
DECLARE
  v_run_id TEXT := 'condition_layer_20260529_source_20260529_v5';
  v_previous_run_id TEXT := 'condition_layer_20260529_source_20260529_v4';
  ref RECORD;
  ref_count BIGINT;
BEGIN
  ...
  FOR ref IN SELECT table_name, column_name FROM _n2_v5_downstream_ref_guard LOOP
...
DELETE FROM stock_condition_display_basis WHERE run_id = 'condition_layer_20260529_source_20260529_v5';
DELETE FROM index_condition_display_basis WHERE run_id = 'condition_layer_20260529_source_20260529_v5';
DELETE FROM board_condition_display_basis WHERE run_id = 'condition_layer_20260529_source_20260529_v5';

DELETE FROM stock_minute_target_scope WHERE run_id = 'condition_layer_20260529_source_20260529_v5';
DELETE FROM index_minute_target_scope WHERE run_id = 'condition_layer_20260529_source_20260529_v5';
DELETE FROM board_minute_target_scope WHERE run_id = 'condition_layer_20260529_source_20260529_v5';

DELETE FROM stock_condition_pool WHERE run_id = 'condition_layer_20260529_source_20260529_v5';
DELETE FROM index_condition_pool WHERE run_id = 'condition_layer_20260529_source_20260529_v5';
DELETE FROM board_condition_pool WHERE run_id = 'condition_layer_20260529_source_20260529_v5';

DELETE FROM stock_condition_basis WHERE run_id = 'condition_layer_20260529_source_20260529_v5';
DELETE FROM index_condition_basis WHERE run_id = 'condition_layer_20260529_source_20260529_v5';
DELETE FROM board_condition_basis WHERE run_id = 'condition_layer_20260529_source_20260529_v5';

DELETE FROM stock_monitor_target WHERE source_version = 'condition_layer_20260529_source_20260529_v5';
DELETE FROM index_monitor_target WHERE source_version = 'condition_layer_20260529_source_20260529_v5';
DELETE FROM board_monitor_target WHERE source_version = 'condition_layer_20260529_source_20260529_v5';

DELETE FROM common_condition_quality_item WHERE run_id = 'condition_layer_20260529_source_20260529_v5';
DELETE FROM common_condition_run WHERE run_id = 'condition_layer_20260529_source_20260529_v5';

UPDATE common_condition_run
SET status = 'passed_active'
WHERE run_id = 'condition_layer_20260529_source_20260529_v4'
