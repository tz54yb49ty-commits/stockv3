-- Roll back only the 052 trading-session guard by restoring the published 048
-- proposal-create definition. Proposal/history rows are preserved.
...
REVOKE ALL ON FUNCTION public.n6_btrack_proposal_create(text,text,bigint) FROM PUBLIC;
