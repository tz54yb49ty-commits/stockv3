...
WHERE source_layer = 'N4_trigger'
  AND source_run_id = 'trigger_projection_matcher_execute_20260602_1105__condition_layer_20260601_source_20260601_v1'
...
WHERE run_id = 'trigger_projection_matcher_execute_20260602_1105__condition_layer_20260601_source_20260601_v1';
...
WHERE consumer_name = 'n4_projection_matcher_consumer_v1'
  AND raw_json ->> 'execute_run_id' = 'trigger_projection_matcher_execute_20260602_1105__condition_layer_20260601_source_20260601_v1';

DELETE FROM common_event_consumer_checkpoint
WHERE consumer_name = 'n4_projection_matcher_consumer_v1'
  AND source_layer = 'N3_market_data'
  AND checkpoint_payload ->> 'execute_run_id' = 'trigger_projection_matcher_execute_20260602_1105__condition_layer_20260601_source_20260601_v1';
