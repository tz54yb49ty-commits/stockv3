-- N3 action-confirmation metric 20260608_scoped_coverage_repair materialization business rollback.
-- Scope: remove only rows for projection_run_id=action_confirmation_metric_20260608_scoped_coverage_repair_v1__trigger_projection_matcher_execute_20260608_v13_index_all_until_1500_formal_snapshot_fallback_retry.
-- Hard-fail before row removal when event infra, downstream N4/N5/N6 refs,
-- downstream_layers_touched, or worker_started indicate consumption.

\set ON_ERROR_STOP on
\set projection_run_id 'action_confirmation_metric_20260608_scoped_coverage_repair_v1__trigger_projection_matcher_execute_20260608_v13_index_all_until_1500_formal_snapshot_fallback_retry'
