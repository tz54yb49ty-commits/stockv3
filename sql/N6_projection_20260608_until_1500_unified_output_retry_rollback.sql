-- N6 projection shadow execute business rollback for 20260608 until 15:00 unified output retry.
-- Do not execute without explicit user confirmation and a reviewed user_projection_run_id.
-- Scope: delete only N6 projection rows created by one scoped shadow projection execute run.
-- Boundary: preserve N5 action facts/outbox status, N4 trigger facts, N3 metric facts, N2/N1 facts,
-- admin/profile/session/watchlist, worker state, delivery/push/voice/mobile, sim/order/trade/position/pnl, and real trade.

BEGIN;

SET LOCAL n6.rollback_user_projection_run_id = 'user_projection_shadow_20260608_until_1500_unified_output_retry__action_consumer_execute_20260608_until_1500_unified_output_retry';
