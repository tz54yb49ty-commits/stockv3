-- N4 trigger rule spec v4 execute rollback.
-- Scope: execute_run_id=trigger_rule_v4_execute_20260603_condition_layer_20260602_source_20260602_v1
...
DO $$
DECLARE
  v_run_id TEXT := 'trigger_rule_v4_execute_20260603_condition_layer_20260602_source_20260602_v1';
  v_count BIGINT;
BEGIN
...
WHERE source_layer = 'N4_trigger'
  AND source_run_id = 'trigger_rule_v4_execute_20260603_condition_layer_20260602_source_20260602_v1';

DELETE FROM common_trigger_match
WHERE run_id = 'trigger_rule_v4_execute_20260603_condition_layer_20260602_source_20260602_v1';
