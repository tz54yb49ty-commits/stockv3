...
-- Scope: execute_run_id=n4_20260615_repaired_formal_price_amount_chain_replay_v1
...
DO $$
DECLARE
  v_run_id TEXT := 'n4_20260615_repaired_formal_price_amount_chain_replay_v1';
  v_count BIGINT;
  v_table TEXT;
BEGIN
...
WHERE source_layer = 'N4_trigger'
  AND source_run_id = 'n4_20260615_repaired_formal_price_amount_chain_replay_v1';

DELETE FROM common_trigger_match
WHERE run_id = 'n4_20260615_repaired_formal_price_amount_chain_replay_v1';
