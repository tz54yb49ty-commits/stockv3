-- N1 20260609 source facts guarded runner rollback.
-- Scope:
--   official_daily_ingest_20260609_v1
--   condition_source_activation_20260609_v1
...
DECLARE
  ...
  v_official_batch_id text := 'official_daily_ingest_20260609_v1';
  v_condition_batch_id text := 'condition_source_activation_20260609_v1';
  v_ref_text text := 'official_daily_ingest_20260609_v1|condition_source_activation_20260609_v1|stock_daily_20260609_v1|index_daily_20260609_v1|board_daily_20260609_v1|stock_daily_basic_20260609_v1|stock_financial_20260609_v1|index_membership_20260609_v1|board_membership_20260609_v1';
...
BEGIN
  ...
  IF v_outbox_refs <> 0
     ...
     OR v_n6_refs <> 0 THEN
    RAISE EXCEPTION
      'Refusing N1 20260609 source facts rollback: outbox %, inbox %, checkpoint %, N2 %, N3 %, N4 %, N5 %, N6 %',
...
WHERE source_batch_id = 'condition_source_activation_20260609_v1'
  ...
  AND (
    (data_domain = 'stock' AND data_type IN ('stock_daily_basic', 'stock_financial') AND scope_key = '20260609')
    OR (data_domain = 'index' AND data_type = 'index_membership' AND scope_key = 'TDX:20260609')
    OR (data_domain = 'board' AND data_type = 'board_membership' AND scope_key = 'TDX:20260609')
  );

DELETE FROM stock_daily_basic
WHERE trade_date = '20260609'
  AND source_batch_id = 'condition_source_activation_20260609_v1'
  AND source_version = 'stock_daily_basic_20260609_v1';

DELETE FROM stock_financial_metrics_fact
WHERE source_trade_date = '20260609'
  AND source_batch_id = 'condition_source_activation_20260609_v1'
  AND source_version = 'stock_financial_20260609_v1';

DELETE FROM index_membership_fact
WHERE trade_date = '20260609'
  AND source_batch_id = 'condition_source_activation_20260609_v1'
  AND source_version = 'index_membership_20260609_v1';

DELETE FROM board_membership_fact
WHERE trade_date = '20260609'
  AND source_batch_id = 'condition_source_activation_20260609_v1'
  AND source_version = 'board_membership_20260609_v1';

DELETE FROM common_active_source_version
WHERE scope_key = '20260609'
  AND source_batch_id = 'official_daily_ingest_20260609_v1'
  AND source_version IN (
...
WHERE trade_date = '20260609'
  AND source_batch_id = 'official_daily_ingest_20260609_v1'
  AND source_version = 'stock_daily_20260609_v1';

DELETE FROM index_daily_bar_fact
WHERE trade_date = '20260609'
  AND source_batch_id = 'official_daily_ingest_20260609_v1'
  AND source_version = 'index_daily_20260609_v1';

DELETE FROM board_daily_bar_fact
WHERE trade_date = '20260609'
  AND source_batch_id = 'official_daily_ingest_20260609_v1'
  AND source_version = 'board_daily_20260609_v1';
