...
-- Scope: execute_run_id=v3_n4_action_confirmation_metric_20260612_after_realtime_virtual_metric_writer_v1
...
DO $$
DECLARE
  v_run_id TEXT := 'v3_n4_action_confirmation_metric_20260612_after_realtime_virtual_metric_writer_v1';
  v_count BIGINT;
BEGIN
...
WHERE source_layer = 'N4_trigger'
  AND source_run_id = 'v3_n4_action_confirmation_metric_20260612_after_realtime_virtual_metric_writer_v1';

DELETE FROM common_trigger_match
WHERE run_id = 'v3_n4_action_confirmation_metric_20260612_after_realtime_virtual_metric_writer_v1';
