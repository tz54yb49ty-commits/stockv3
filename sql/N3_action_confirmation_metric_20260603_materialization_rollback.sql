-- N3 action-confirmation metric 20260603 materialization business rollback.
-- Scope: delete only rows for projection_run_id=action_confirmation_projection_metric_20260603__trigger_rule_v4_execute_20260603_condition_layer_20260602_source_20260602_v1.
...
\set projection_run_id 'action_confirmation_projection_metric_20260603__trigger_rule_v4_execute_20260603_condition_layer_20260602_source_20260602_v1'
...
BEGIN
  ...
  IF to_regclass('user_card_projection') IS NOT NULL THEN
    EXECUTE 'SELECT count(*) FROM user_card_projection WHERE raw_json::TEXT LIKE $1'
      INTO n6_refs
      USING '%' || target_run_id || '%';
  ELSE
    n6_refs := 0;
