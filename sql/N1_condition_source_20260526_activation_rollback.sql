-- N1 condition source activation 20260526 rollback draft.
-- Scope: condition source activation batch condition_source_activation_20260526_v1.
...
BEGIN
  ...
  WHERE a.source_batch_id = 'condition_source_activation_20260526_v1'
    AND (
...
WHERE source_batch_id = 'condition_source_activation_20260526_v1'
...
WHERE trade_date = '20260526'
  AND source_batch_id = 'condition_source_activation_20260526_v1'
  AND source_version = 'stock_daily_basic_20260526_v1';

DELETE FROM stock_financial_metrics_fact
WHERE source_trade_date = '20260526'
  AND source_batch_id = 'condition_source_activation_20260526_v1'
  AND source_version = 'stock_financial_20260526_v1';

DELETE FROM index_membership_fact
WHERE trade_date = '20260526'
  AND source_batch_id = 'condition_source_activation_20260526_v1'
  AND source_version = 'index_membership_20260526_v1';

DELETE FROM board_membership_fact
WHERE trade_date = '20260526'
  AND source_batch_id = 'condition_source_activation_20260526_v1'
  AND source_version = 'board_membership_20260526_v1';

DELETE FROM common_quality_gate_result
WHERE source_batch_id = 'condition_source_activation_20260526_v1'
   OR source_version IN (
     'condition_source_activation_20260526_v1',
     'stock_daily_basic_20260526_v1',
     'stock_financial_20260526_v1',
     'index_membership_20260526_v1',
     'board_membership_20260526_v1'
   );

DELETE FROM common_ingest_batch
WHERE batch_id = 'condition_source_activation_20260526_v1'
   OR source_version = 'condition_source_activation_20260526_v1';
