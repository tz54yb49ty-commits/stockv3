-- Rollback for 20260608 trigger-time aligned N3 action-confirmation metric materialization.
-- Scope: projection_run_id=action_confirmation_metric_20260608_trigger_time_aligned_until_1500__trigger_projection_matcher_execute_20260608_v13_index_all_until_1500_v4_repair_retry

BEGIN;

DO $$
DECLARE
  v_run_id TEXT := 'action_confirmation_metric_20260608_trigger_time_aligned_until_1500__trigger_projection_matcher_execute_20260608_v13_index_all_until_1500_v4_repair_retry';
...
BEGIN
  ...
  LOOP
    ...
    END IF;
  END LOOP;
  SELECT count(*)::bigint INTO v_ref_count
...
WHERE projection_run_id = 'action_confirmation_metric_20260608_trigger_time_aligned_until_1500__trigger_projection_matcher_execute_20260608_v13_index_all_until_1500_v4_repair_retry';
...
WHERE run_id = 'action_confirmation_metric_20260608_trigger_time_aligned_until_1500__trigger_projection_matcher_execute_20260608_v13_index_all_until_1500_v4_repair_retry'
