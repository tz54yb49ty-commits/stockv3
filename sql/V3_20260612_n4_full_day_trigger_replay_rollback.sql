...
-- Scope: execute_run_id=v3_n4_trigger_replay_20260612_after_n3_full_day_metric_state_machine_v3
...
DO $$
DECLARE
  v_run_id TEXT := 'v3_n4_trigger_replay_20260612_after_n3_full_day_metric_state_machine_v3';
  v_count BIGINT;
BEGIN
...
WHERE source_layer = 'N4_trigger'
  AND source_run_id = 'v3_n4_trigger_replay_20260612_after_n3_full_day_metric_state_machine_v3';

DELETE FROM common_trigger_match
WHERE run_id = 'v3_n4_trigger_replay_20260612_after_n3_full_day_metric_state_machine_v3';
