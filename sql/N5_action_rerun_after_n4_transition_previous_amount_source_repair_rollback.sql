-- N5 scoped rollback for transition previous amount source repair N5 action rerun.
-- Generated by docs/N5_ACTION_RERUN_AFTER_N4_TRANSITION_PREVIOUS_AMOUNT_SOURCE_REPAIR_PASS_PREFLIGHT.json
-- Execute only after the corresponding N5 execute run has been explicitly authorized and reviewed.
-- Scope:
...
\set action_run_id 'action_consumer_execute_20260617_until_1352_after_n4_transition_previous_amount_source_repair__trigger_action_confirmation_metric_execute_20260617_until_1352_transition_previous_amount_source_repair__condition_layer_20260616_source_20260616_for_20260617_semantic_repair_v1'
\set source_trigger_run_id 'trigger_action_confirmation_metric_execute_20260617_until_1352_transition_previous_amount_source_repair__condition_layer_20260616_source_20260616_for_20260617_semantic_repair_v1'
...
UNION ALL
SELECT 'common_event_ledger_n5', count(*)
FROM common_event_ledger
WHERE source_layer = 'N5_action'
  AND source_run_id = :'action_run_id'
UNION ALL
